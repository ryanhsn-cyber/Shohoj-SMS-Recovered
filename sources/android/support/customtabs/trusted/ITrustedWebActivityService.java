...
public interface ITrustedWebActivityService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITrustedWebActivityService {
        ...
        public static ITrustedWebActivityService asInterface(IBinder obj) {
            ...
            if (iin != null && (iin instanceof ITrustedWebActivityService)) {
                return (ITrustedWebActivityService) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 2:
                    ...
                    Bundle _result = notifyNotificationWithChannel(_arg0);
                ...
                case 3:
                    ...
                    cancelNotification(_arg02);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    int _result2 = getSmallIconId();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result3 = getActiveNotifications();
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 6:
                    ...
                    Bundle _result4 = areNotificationsEnabled(_arg03);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result5 = getSmallIconBitmap();
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 9:
                    ...
                    Bundle _result6 = extraCommand(_arg04, _arg1, _arg2);
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
