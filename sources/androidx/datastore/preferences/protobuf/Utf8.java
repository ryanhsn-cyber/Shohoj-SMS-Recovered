        ...
        String decodeUtf8(byte[] bytes, int index, int size) throws InvalidProtocolBufferException {
            ...
            while (offset < limit) {
                ...
                if (DecodeUtil.isOneByte(byte1)) {
                    ...
                    int offset4 = offset2 + 1;
                    byte b3 = UnsafeUtil.getByte(bytes, offset2);
                    int offset5 = offset4 + 1;
                    DecodeUtil.handleFourBytes(byte1, b3, UnsafeUtil.getByte(bytes, offset4), UnsafeUtil.getByte(bytes, offset5), resultArr, resultPos2);
                    offset = offset5 + 1;
                    resultPos2 = resultPos2 + 1 + 1;
                }
            }
        ...
        int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            while (inIx < inLimit) {
                ...
                if (c3 < c && outIx2 < outLimit) {
                    ...
                    UnsafeUtil.putByte(out, outIx6, (byte) (((c3 >>> 6) & 63) | 128));
                    UnsafeUtil.putByte(out, outIx7, (byte) ((c3 & '?') | 128));
                    outIx = outLimit;
                    outIx2 = outIx7 + 1;
                    c = 128;
                }
        ...
        void encodeUtf8Direct(CharSequence in, ByteBuffer out) {
            ...
            while (inIx < inLimit) {
                ...
                if (c4 < c && outIx2 < outLimit) {
                    ...
                    long outIx7 = outIx6 + j;
                    UnsafeUtil.putByte(outIx6, (byte) (((c4 >>> 6) & 63) | 128));
                    UnsafeUtil.putByte(outIx7, (byte) ((c4 & '?') | 128));
                    outIx2 = outIx7 + j;
                    j2 = j;
                    c2 = 128;
                } else {
