    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 34) {
                accessibilityAction2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_IN_DIRECTION;
            } else {
                accessibilityAction2 = null;
            }
            ACTION_SCROLL_IN_DIRECTION = new AccessibilityActionCompat(accessibilityAction2, R.id.KEYCODE_3D_MODE, null, null, null);
        }
