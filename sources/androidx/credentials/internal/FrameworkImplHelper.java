...
public final class FrameworkImplHelper {
    ...
    public static final class Companion {
        ...
        public final Bundle getFinalCreateCredentialData(CreateCredentialRequest request, Context context) {
            ...
            Bundle createCredentialData = request.getCredentialData();
            Bundle displayInfoBundle = request.getDisplayInfo().toBundle();
            ...
            displayInfoBundle.putParcelable(CreateCredentialRequest.DisplayInfo.BUNDLE_KEY_CREDENTIAL_TYPE_ICON, Icon.createWithResource(context, i));
            createCredentialData.putBundle(CreateCredentialRequest.DisplayInfo.BUNDLE_KEY_REQUEST_DISPLAY_INFO, displayInfoBundle);
