...
public final class FidoPublicKeyCredential {
    ...
    public final String json() {
        String encodedId = WebAuthnUtils.INSTANCE.b64Encode(this.rawId);
        JSONObject ret = new JSONObject();
        ret.put("id", encodedId);
        ret.put("rawId", encodedId);
        ret.put("type", "public-key");
        ret.put("authenticatorAttachment", this.authenticatorAttachment);
        ret.put("response", this.response.json());
        ret.put("clientExtensionResults", new JSONObject());
        String jSONObject = ret.toString();
        Intrinsics.checkNotNullExpressionValue(jSONObject, "ret.toString()");
        return jSONObject;
    }
}
