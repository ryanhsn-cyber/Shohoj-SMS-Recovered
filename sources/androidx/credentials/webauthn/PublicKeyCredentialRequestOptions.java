...
public final class PublicKeyCredentialRequestOptions {
    ...
    public PublicKeyCredentialRequestOptions(String requestJson) {
        ...
        this.json = new JSONObject(requestJson);
        String challengeString = this.json.getString(ClientData.KEY_CHALLENGE);
        ...
        String optString = this.json.optString("rpId", "");
        Intrinsics.checkNotNullExpressionValue(optString, "json.optString(\"rpId\", \"\")");
        this.rpId = optString;
        String optString2 = this.json.optString("userVerification", "preferred");
