...
public final class PublicKeyCredential extends Credential {
    ...
    private PublicKeyCredential(String authenticationResponseJson, Bundle data) {
        super(TYPE_PUBLIC_KEY_CREDENTIAL, data);
        this.authenticationResponseJson = authenticationResponseJson;
        if (RequestValidationHelper.INSTANCE.isValidJSON(this.authenticationResponseJson)) {
        } else {
    ...
    public static final class Companion {
        ...
        public final PublicKeyCredential createFrom$credentials_release(Bundle data) {
            ...
            try {
                String authenticationResponseJson = data.getString(PublicKeyCredential.BUNDLE_KEY_AUTHENTICATION_RESPONSE_JSON);
                Intrinsics.checkNotNull(authenticationResponseJson);
                return new PublicKeyCredential(authenticationResponseJson, data, null);
            } catch (Exception e) {
