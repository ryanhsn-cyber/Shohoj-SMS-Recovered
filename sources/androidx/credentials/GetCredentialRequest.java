...
public final class GetCredentialRequest {
    ...
    public GetCredentialRequest(List<? extends CredentialOption> credentialOptions, String origin, boolean preferIdentityDocUi, ComponentName preferUiBrandingComponentName, boolean preferImmediatelyAvailableCredentials) {
        Intrinsics.checkNotNullParameter(credentialOptions, "credentialOptions");
        this.credentialOptions = credentialOptions;
        this.origin = origin;
        this.preferIdentityDocUi = preferIdentityDocUi;
        this.preferUiBrandingComponentName = preferUiBrandingComponentName;
        this.preferImmediatelyAvailableCredentials = preferImmediatelyAvailableCredentials;
        if (!(!this.credentialOptions.isEmpty())) {
    ...
    public static final class Companion {
        ...
        public final GetCredentialRequest createFrom(List<? extends CredentialOption> credentialOptions, String origin, Bundle data) {
            ...
            try {
                boolean preferIdentityDocUi = data.getBoolean(GetCredentialRequest.BUNDLE_KEY_PREFER_IDENTITY_DOC_UI);
                boolean preferImmediatelyAvailableCredentials = data.getBoolean("androidx.credentials.BUNDLE_KEY_PREFER_IMMEDIATELY_AVAILABLE_CREDENTIALS");
                ComponentName preferUiBrandingComponentName = (ComponentName) data.getParcelable(GetCredentialRequest.BUNDLE_KEY_PREFER_UI_BRANDING_COMPONENT_NAME);
                Builder getCredentialBuilder = new Builder().setCredentialOptions(credentialOptions).setPreferIdentityDocUi(preferIdentityDocUi).setPreferUiBrandingComponentName(preferUiBrandingComponentName).setPreferImmediatelyAvailableCredentials(preferImmediatelyAvailableCredentials);
                if (origin != null) {
