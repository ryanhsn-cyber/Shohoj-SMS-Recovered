...
public final class GetPublicKeyCredentialOption extends CredentialOption {
    ...
    private GetPublicKeyCredentialOption(String requestJson, byte[] clientDataHash, Set<ComponentName> set, Bundle requestData, Bundle candidateQueryData) {
        super(PublicKeyCredential.TYPE_PUBLIC_KEY_CREDENTIAL, requestData, candidateQueryData, false, true, set);
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public GetPublicKeyCredentialOption(String requestJson, byte[] clientDataHash, Set<ComponentName> allowedProviders) {
        this(requestJson, clientDataHash, allowedProviders, INSTANCE.toRequestDataBundle$credentials_release(requestJson, clientDataHash), INSTANCE.toRequestDataBundle$credentials_release(requestJson, clientDataHash));
        Intrinsics.checkNotNullParameter(requestJson, "requestJson");
    ...
    public static final class Companion {
        ...
        public final GetPublicKeyCredentialOption createFrom$credentials_release(Bundle data, Set<ComponentName> allowedProviders, Bundle candidateQueryData) {
            ...
            try {
                ...
                return new GetPublicKeyCredentialOption(requestJson, clientDataHash, allowedProviders, data, candidateQueryData, null);
            } catch (Exception e) {
