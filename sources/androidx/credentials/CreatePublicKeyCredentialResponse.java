...
public final class CreatePublicKeyCredentialResponse extends CreateCredentialResponse {
    ...
    private CreatePublicKeyCredentialResponse(String registrationResponseJson, Bundle data) {
        super(PublicKeyCredential.TYPE_PUBLIC_KEY_CREDENTIAL, data);
        this.registrationResponseJson = registrationResponseJson;
        if (RequestValidationHelper.INSTANCE.isValidJSON(this.registrationResponseJson)) {
        } else {
    ...
    public static final class Companion {
        ...
        public final CreatePublicKeyCredentialResponse createFrom$credentials_release(Bundle data) {
            ...
            try {
                String registrationResponseJson = data.getString(CreatePublicKeyCredentialResponse.BUNDLE_KEY_REGISTRATION_RESPONSE_JSON);
                Intrinsics.checkNotNull(registrationResponseJson);
                return new CreatePublicKeyCredentialResponse(registrationResponseJson, data, null);
            } catch (Exception e) {
