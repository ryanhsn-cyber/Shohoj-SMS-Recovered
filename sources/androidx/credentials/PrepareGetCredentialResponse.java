...
public final class PrepareGetCredentialResponse {
    ...
    private PrepareGetCredentialResponse(PendingGetCredentialHandle pendingGetCredentialHandle, Function0<Boolean> function0, Function0<Boolean> function02, Function1<? super String, Boolean> function1, boolean isNullHandlesForTest) {
        ...
        this.isNullHandlesForTest = isNullHandlesForTest;
        if (Build.VERSION.SDK_INT < 34 || this.isNullHandlesForTest) {
            return;
        }
        Intrinsics.checkNotNull(this.pendingGetCredentialHandle);
    }
    ...
    public final boolean hasCredentialResults(String credentialType) {
        ...
        if (this.credentialTypeDelegate != null) {
            return this.credentialTypeDelegate.invoke(credentialType).booleanValue();
        }
        return false;
    }

    public final boolean hasAuthenticationResults() {
        if (this.hasAuthResultsDelegate != null) {
            return this.hasAuthResultsDelegate.invoke().booleanValue();
        }
        return false;
    }

    public final boolean hasRemoteResults() {
        if (this.hasRemoteResultsDelegate != null) {
            return this.hasRemoteResultsDelegate.invoke().booleanValue();
        }
        return false;
    }
    ...
    public static final class PendingGetCredentialHandle {
        ...
        public PendingGetCredentialHandle(PrepareGetCredentialResponse.PendingGetCredentialHandle frameworkHandle) {
            this.frameworkHandle = frameworkHandle;
            if (Build.VERSION.SDK_INT < 34) {
                return;
            }
            Intrinsics.checkNotNull(this.frameworkHandle);
        }
