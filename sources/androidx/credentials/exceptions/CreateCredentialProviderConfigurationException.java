...
public final class CreateCredentialProviderConfigurationException extends CreateCredentialException {
    ...
    public CreateCredentialProviderConfigurationException(CharSequence errorMessage) {
        super(TYPE_CREATE_CREDENTIAL_PROVIDER_CONFIGURATION_EXCEPTION, errorMessage);
    }
}
