...
public final class BeginCreatePublicKeyCredentialRequest extends BeginCreateCredentialRequest {
    ...
    public BeginCreatePublicKeyCredentialRequest(String requestJson, CallingAppInfo callingAppInfo, Bundle candidateQueryData, byte[] clientDataHash) {
        ...
        initiateBundle(candidateQueryData, this.requestJson);
    }
    ...
    public static final class Companion {
        ...
        public final BeginCreatePublicKeyCredentialRequest createFrom$credentials_release(Bundle data, CallingAppInfo callingAppInfo) {
            ...
            try {
                ...
                return new BeginCreatePublicKeyCredentialRequest(requestJson, callingAppInfo, data, clientDataHash);
            } catch (Exception e) {
