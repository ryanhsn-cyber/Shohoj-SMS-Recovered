...
public final class AuthenticationAction {
    ...
    public static final class Companion {
        ...
        public final Slice toSlice(AuthenticationAction authenticationAction) {
            ...
            Slice.Builder sliceBuilder = new Slice.Builder(Uri.EMPTY, new SliceSpec("AuthenticationAction", 0));
            sliceBuilder.addAction(pendingIntent, new Slice.Builder(sliceBuilder).addHints(Collections.singletonList(AuthenticationAction.SLICE_HINT_PENDING_INTENT)).build(), null).addText(title, null, CollectionsKt.listOf(AuthenticationAction.SLICE_HINT_TITLE));
        ...
        public final AuthenticationAction fromSlice(Slice slice) {
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                if (it.hasHint(AuthenticationAction.SLICE_HINT_PENDING_INTENT)) {
                    pendingIntent = it.getAction();
                } else if (it.hasHint(AuthenticationAction.SLICE_HINT_TITLE)) {
