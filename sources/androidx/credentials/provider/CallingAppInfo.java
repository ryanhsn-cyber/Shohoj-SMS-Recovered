...
public final class CallingAppInfo {
    ...
    private final boolean isAppPrivileged(List<PrivilegedApp> candidateApps) {
        for (PrivilegedApp app : candidateApps) {
            if (Intrinsics.areEqual(app.getPackageName(), this.packageName)) {
                return isAppPrivileged(app.getFingerprints());
            }
        }
        return false;
    }
    ...
    public static final class SignatureVerifierApi28 {
        ...
        private final Set<String> getSignatureFingerprints() {
            ...
            if (this.signingInfo.hasMultipleSigners() && this.signingInfo.getApkContentsSigners() != null) {
                ...
                fingerprints.addAll(convertToFingerprints(new Signature[]{signature}));
            }
            return fingerprints;
        }
        ...
        private final Set<String> convertToFingerprints(Signature[] signatures) {
            ...
            for (Signature signature : signatures) {
                ...
                fingerprints.add(ArraysKt.joinToString$default(digest, (CharSequence) ":", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) new Function1<Byte, CharSequence>() { // from class: androidx.credentials.provider.CallingAppInfo$SignatureVerifierApi28$convertToFingerprints$1
        ...
        public final boolean verifySignatureFingerprints(Set<String> candidateSigFingerprints) {
            ...
            Set appSigFingerprints = getSignatureFingerprints();
            if (this.signingInfo.hasMultipleSigners()) {
                return candidateSigFingerprints.containsAll(appSigFingerprints);
            }
            return !CollectionsKt.intersect(candidateSigFingerprints, appSigFingerprints).isEmpty();
        }
    }
}
