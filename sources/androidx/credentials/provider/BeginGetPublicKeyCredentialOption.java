...
public final class BeginGetPublicKeyCredentialOption extends BeginGetCredentialOption {
    ...
    public BeginGetPublicKeyCredentialOption(Bundle candidateQueryData, String id, String requestJson, byte[] clientDataHash) {
        ...
        if (!RequestValidationUtil.INSTANCE.isValidJSON(this.requestJson)) {
    ...
    public static final class Companion {
        ...
        public final BeginGetPublicKeyCredentialOption createFrom$credentials_release(Bundle data, String id) {
            ...
            try {
                ...
                return new BeginGetPublicKeyCredentialOption(data, id, requestJson, clientDataHash);
            } catch (Exception e) {
        ...
        public final BeginGetPublicKeyCredentialOption createFromEntrySlice$credentials_release(Bundle data, String id) {
            Intrinsics.checkNotNullParameter(data, "data");
            Intrinsics.checkNotNullParameter(id, "id");
            String requestJson = "{\"dummy_key\":\"dummy_value\"}";
            return new BeginGetPublicKeyCredentialOption(data, id, requestJson, null, 8, null);
        }
    }
}
