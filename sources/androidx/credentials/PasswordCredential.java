...
public final class PasswordCredential extends Credential {
    ...
    private PasswordCredential(String id, String password, Bundle data) {
        super(TYPE_PASSWORD_CREDENTIAL, data);
        this.id = id;
    ...
    public static final class Companion {
        ...
        public final PasswordCredential createFrom$credentials_release(Bundle data) {
            ...
            try {
                ...
                return new PasswordCredential(id, password, data, null);
            } catch (Exception e) {
