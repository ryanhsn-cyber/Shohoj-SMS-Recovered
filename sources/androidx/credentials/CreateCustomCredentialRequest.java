...
public class CreateCustomCredentialRequest extends CreateCredentialRequest {
    ...
    public CreateCustomCredentialRequest(String type, Bundle credentialData, Bundle candidateQueryData, boolean isSystemProviderRequired, CreateCredentialRequest.DisplayInfo displayInfo, boolean isAutoSelectAllowed, String origin, boolean preferImmediatelyAvailableCredentials) {
        super(type, credentialData, candidateQueryData, isSystemProviderRequired, isAutoSelectAllowed, displayInfo, origin, preferImmediatelyAvailableCredentials);
        Intrinsics.checkNotNullParameter(type, "type");
        Intrinsics.checkNotNullParameter(credentialData, "credentialData");
        Intrinsics.checkNotNullParameter(candidateQueryData, "candidateQueryData");
        Intrinsics.checkNotNullParameter(displayInfo, "displayInfo");
