...
public class ViewPager extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    ...
                    if (consumeVertical) {
                        ...
                        heightMode3 = Ints.MAX_POWER_OF_TWO;
                    }
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthSize, Ints.MAX_POWER_OF_TWO);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, Ints.MAX_POWER_OF_TWO);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                int widthSpec2 = View.MeasureSpec.makeMeasureSpec((int) (childWidthSize * lp.widthFactor), Ints.MAX_POWER_OF_TWO);
                        ...
                        if (lp2.isDecor) {
                            ...
                            if (ii == null) {
                                ...
                                if (!lp2.needsMeasure) {
                                    ...
                                    width = width2;
                                    int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childWidth * lp2.widthFactor), Ints.MAX_POWER_OF_TWO);
                                    paddingLeft = paddingLeft2;
                                    int paddingLeft5 = (height - paddingTop) - paddingBottom;
                                    int heightSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft5, Ints.MAX_POWER_OF_TWO);
