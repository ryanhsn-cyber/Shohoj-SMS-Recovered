...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m2288assert(this.nodeMap == 0);
        CommonFunctionsKt.m2288assert(this.dataMap == 0);
        CommonFunctionsKt.m2288assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m2288assert(otherNode.dataMap == 0);
