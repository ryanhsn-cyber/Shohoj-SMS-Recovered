...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2275boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2276constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2277equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2278equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2279hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2284toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2277equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2279hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2284toStringimpl(this.composer);
    }
    ...
    public static final void m2282setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2283setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2285updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2286updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = arg0.getInserting();
    ...
    public static final void m2280initimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2281reconcileimpl(Composer arg0, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
