...
public final class GroupKind {
    ...
    private static final int Group = m2256constructorimpl(0);
    private static final int Node = m2256constructorimpl(1);
    private static final int ReusableNode = m2256constructorimpl(2);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m2255boximpl(int i) {
    ...
    public static boolean m2257equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m2263unboximpl();
    }
    ...
    public static String m2262toStringimpl(int i) {
    ...
    public String toString() {
        return m2262toStringimpl(this.value);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m2263unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m2260isNodeimpl(int arg0) {
        return arg0 != INSTANCE.m2264getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m2261isReusableimpl(int arg0) {
        return arg0 != INSTANCE.m2265getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m2264getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs, reason: not valid java name */
        public final int m2265getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs, reason: not valid java name */
        public final int m2266getReusableNodeULZAiWs() {
