...
public interface PointerDirectionConfig {
    ...
    float mo278crossAxisDeltak4lQ0M(long offset);

    /* renamed from: mainAxisDelta-k-4lQ0M */
    float mo279mainAxisDeltak4lQ0M(long offset);

    /* renamed from: offsetFromChanges-dBAh8RU */
    long mo280offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}
