...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo433calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
    ...
    public float mo434calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
