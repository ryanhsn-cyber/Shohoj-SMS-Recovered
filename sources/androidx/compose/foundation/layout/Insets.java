...
final class Insets implements WindowInsets {
    ...
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m4902toStringimpl(this.left)) + ", top=" + ((Object) Dp.m4902toStringimpl(this.top)) + ", right=" + ((Object) Dp.m4902toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m4902toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Insets) {
            return Dp.m4896equalsimpl0(this.left, ((Insets) other).left) && Dp.m4896equalsimpl0(this.top, ((Insets) other).top) && Dp.m4896equalsimpl0(this.right, ((Insets) other).right) && Dp.m4896equalsimpl0(this.bottom, ((Insets) other).bottom);
        }
        return false;
    }

    public int hashCode() {
        int result = Dp.m4897hashCodeimpl(this.left);
        return (((((result * 31) + Dp.m4897hashCodeimpl(this.top)) * 31) + Dp.m4897hashCodeimpl(this.right)) * 31) + Dp.m4897hashCodeimpl(this.bottom);
    }
}
