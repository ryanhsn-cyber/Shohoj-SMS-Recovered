...
final class AndroidFlingSpline {
    ...
    public final long m383flingPositionLfoxSSI(float time) {
        float f = 100;
        ...
        return FlingResult.m385constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m384boximpl(long j) {
            return new FlingResult(j);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static long m385constructorimpl(long j) {
            return j;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m386equalsimpl(long j, Object obj) {
        ...
        public static String m391toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m386equalsimpl(this.packedValue, obj);
        }
        ...
        public String toString() {
            return m391toStringimpl(this.packedValue);
        }
        ...
        public static final float m388getDistanceCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (arg0 >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m389getVelocityCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
