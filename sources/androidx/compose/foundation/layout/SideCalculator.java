...
interface SideCalculator {
    ...
    long mo510consumedOffsetsMKHz9U(long available);

    /* renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo511consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo510consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m2403getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo511consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m5116getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo510consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m2404getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo511consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m5117getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m512chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            if (WindowInsetsSides.m563equalsimpl0(side, WindowInsetsSides.INSTANCE.m577getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m563equalsimpl0(side, WindowInsetsSides.INSTANCE.m580getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m563equalsimpl0(side, WindowInsetsSides.INSTANCE.m578getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m563equalsimpl0(side, WindowInsetsSides.INSTANCE.m574getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m563equalsimpl0(side, WindowInsetsSides.INSTANCE.m579getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (!WindowInsetsSides.m563equalsimpl0(side, WindowInsetsSides.INSTANCE.m575getEndJoeWqyM())) {
