...
final class PaddingValues implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo321roundToPx0680j_4(this.paddingValues.mo433calculateLeftPaddingu2uoSUM(layoutDirection));
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo321roundToPx0680j_4(this.paddingValues.mo434calculateRightPaddingu2uoSUM(layoutDirection));
    }
    ...
    public String toString() {
        ...
        float start = this.paddingValues.mo433calculateLeftPaddingu2uoSUM(layoutDirection);
        float top = this.paddingValues.getTop();
        float end = this.paddingValues.mo434calculateRightPaddingu2uoSUM(layoutDirection);
        float bottom = this.paddingValues.getBottom();
        return "PaddingValues(" + ((Object) Dp.m4902toStringimpl(start)) + ", " + ((Object) Dp.m4902toStringimpl(top)) + ", " + ((Object) Dp.m4902toStringimpl(end)) + ", " + ((Object) Dp.m4902toStringimpl(bottom)) + ')';
    }
