...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m760cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3622equalsimpl0(KeyEvent_androidKt.m3630getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m3627getKeyUpCS__XNY());
    }
