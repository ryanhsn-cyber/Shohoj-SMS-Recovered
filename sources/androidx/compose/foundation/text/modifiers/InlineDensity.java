...
public final class InlineDensity {
    ...
    private static final long Unspecified = m842constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m841boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m843constructorimpl(long j) {
        return j;
    }
    ...
    public int hashCode() {
        return m849hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m842constructorimpl(float density, float fontScale) {
        long v1$iv = Float.floatToIntBits(density);
        long v2$iv = Float.floatToIntBits(fontScale);
        return m843constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m844constructorimpl(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return m842constructorimpl(density.getDensity(), density.getFontScale());
    }

    /* renamed from: getDensity-impl, reason: not valid java name */
    public static final float m847getDensityimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m848getFontScaleimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    public String toString() {
        return m850toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m850toStringimpl(long arg0) {
        return "InlineDensity(density=" + m847getDensityimpl(arg0) + ", fontScale=" + m848getFontScaleimpl(arg0) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m852getUnspecifiedL26CHvs() {
