...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo888calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        Intrinsics.checkNotNullParameter(anchorBounds, "anchorBounds");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        switch (WhenMappings.$EnumSwitchMapping$0[this.handleReferencePoint.ordinal()]) {
            case 1:
                return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m5009getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m5010getYimpl(this.offset));
            case 2:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5009getXimpl(this.offset)) - IntSize.m5051getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m5010getYimpl(this.offset));
            case 3:
                return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m5009getXimpl(this.offset)) - (IntSize.m5051getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m5010getYimpl(this.offset));
            default:
