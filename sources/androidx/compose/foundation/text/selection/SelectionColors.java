...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SelectionColors) && Color.m2643equalsimpl0(this.selectionHandleColor, ((SelectionColors) other).selectionHandleColor) && Color.m2643equalsimpl0(this.selectionBackgroundColor, ((SelectionColors) other).selectionBackgroundColor);
    }

    public int hashCode() {
        int result = Color.m2649hashCodeimpl(this.selectionHandleColor);
        return (result * 31) + Color.m2649hashCodeimpl(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m2650toStringimpl(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m2650toStringimpl(this.selectionBackgroundColor)) + ')';
    }
}
