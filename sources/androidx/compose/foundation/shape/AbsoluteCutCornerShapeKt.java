...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m719AbsoluteCutCornerShape0680j_4(float size) {
        return AbsoluteCutCornerShape(CornerSizeKt.m727CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ AbsoluteCutCornerShape m721AbsoluteCutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4891constructorimpl(0);
        }
        int $i$f$getDp = i & 2;
        if ($i$f$getDp != 0) {
            f2 = Dp.m4891constructorimpl(0);
        }
        int $i$f$getDp2 = i & 4;
        if ($i$f$getDp2 != 0) {
            f3 = Dp.m4891constructorimpl(0);
        }
        if ((i & 8) != 0) {
            f4 = Dp.m4891constructorimpl(0);
        }
        return m720AbsoluteCutCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteCutCornerShape m720AbsoluteCutCornerShapea9UjIt4(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m727CornerSize0680j_4(topLeft), CornerSizeKt.m727CornerSize0680j_4(topRight), CornerSizeKt.m727CornerSize0680j_4(bottomRight), CornerSizeKt.m727CornerSize0680j_4(bottomLeft));
    }
