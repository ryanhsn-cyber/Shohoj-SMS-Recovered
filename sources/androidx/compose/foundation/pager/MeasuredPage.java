...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < size) {
            ...
            long offset = m689getOffsetBjo55l4(index);
            if (!this.reverseLayout) {
                i = i2;
            } else {
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m5009getXimpl(offset);
                    i = i2;
                } else {
                    int mainAxisOffset2 = IntOffset.m5009getXimpl(offset);
                    i = i2;
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m5010getYimpl(offset);
                    m5010getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    m5010getYimpl = IntOffset.m5010getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(mainAxisOffset, m5010getYimpl);
            }
            long other$iv = this.visualOffset;
            long other$iv2 = IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(offset) + IntOffset.m5009getXimpl(other$iv), IntOffset.m5010getYimpl(offset) + IntOffset.m5010getYimpl(other$iv));
            if (this.isVertical) {
                Placeable.PlacementScope.m3940placeWithLayeraW9wM$default(scope, placeable, other$iv2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m3939placeRelativeWithLayeraW9wM$default(scope, placeable, other$iv2, 0.0f, null, 6, null);
            }
            i3++;
            i2 = i;
        }
    ...
    private final long m689getOffsetBjo55l4(int index) {
    ...
    private final long m688copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
        return IntOffsetKt.IntOffset(this.isVertical ? IntOffset.m5009getXimpl($this$copy_u2d4Tuh3kE) : function1.invoke(Integer.valueOf(IntOffset.m5009getXimpl($this$copy_u2d4Tuh3kE))).intValue(), this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m5010getYimpl($this$copy_u2d4Tuh3kE))).intValue() : IntOffset.m5010getYimpl($this$copy_u2d4Tuh3kE));
    }
}
