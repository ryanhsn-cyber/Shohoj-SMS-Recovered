...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo642schedulePrefetch0kLqBqw(int index, long constraints);
    }
    ...
    /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m641schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle mo642schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (mo642schedulePrefetch0kLqBqw = prefetcher.mo642schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : mo642schedulePrefetch0kLqBqw;
    }
}
