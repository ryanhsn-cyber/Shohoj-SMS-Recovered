                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        if (active$iv) {
                            ...
                            LazyLayoutItemContentFactoryKt.m638access$SkippableItemJVlU9Rs(itemProvider, StableValue.m645constructorimpl(saveableStateHolder), index, StableValue.m645constructorimpl(cachedItemContent.getKey()), $composer, 0);
