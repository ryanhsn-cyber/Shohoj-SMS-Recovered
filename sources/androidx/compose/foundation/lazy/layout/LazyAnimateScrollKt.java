...
public final class LazyAnimateScrollKt {
    ...
    private static final float TargetDistance = Dp.m4891constructorimpl(2500);
    private static final float BoundDistance = Dp.m4891constructorimpl(ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED);
    private static final float MinimumDistance = Dp.m4891constructorimpl(50);
