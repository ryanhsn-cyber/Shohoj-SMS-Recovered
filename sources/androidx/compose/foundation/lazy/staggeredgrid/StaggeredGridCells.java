...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        private Adaptive(float minSize) {
            ...
            if (Dp.m4890compareTo0680j_4(this.minSize, Dp.m4891constructorimpl((float) 0)) > 0) {
            } else {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
        }
        ...
        public int hashCode() {
            return Dp.m4897hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m4896equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
    ...
    public static final class FixedSize implements StaggeredGridCells {
        ...
        public int hashCode() {
            return Dp.m4897hashCodeimpl(this.size);
        }

        public boolean equals(Object other) {
            return (other instanceof FixedSize) && Dp.m4896equalsimpl0(this.size, ((FixedSize) other).size);
        }
    }
}
