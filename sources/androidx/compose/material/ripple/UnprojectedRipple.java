...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m984setColorDxMtmZc(long color, float alpha) {
        long newColor = m983calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m2643equalsimpl0(color2.m2652unboximpl(), newColor))) {
            this.rippleColor = Color.m2632boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m2696toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m983calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        m2640copywmQWz5c = Color.m2640copywmQWz5c(color, (r12 & 1) != 0 ? Color.m2644getAlphaimpl(color) : transformedAlpha, (r12 & 2) != 0 ? Color.m2648getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m2647getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m2645getBlueimpl(color) : 0.0f);
        return m2640copywmQWz5c;
    }
