...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        ...
        if (delta < 0.0f && NestedScrollSource.m3654equalsimpl0(source, NestedScrollSource.INSTANCE.m3659getDragWNlRxjI())) {
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (NestedScrollSource.m3654equalsimpl0(source, NestedScrollSource.INSTANCE.m3659getDragWNlRxjI())) {
    ...
    */
    public java.lang.Object mo559onPreFlingQWom1Mo(long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L34:
            kotlin.ResultKt.throwOnFailure(r0)
            r2 = r6
            float r3 = androidx.compose.ui.unit.Velocity.m5116getXimpl(r7)
            float r4 = androidx.compose.ui.unit.Velocity.m5117getYimpl(r7)
        ...
        L76:
            ...
            long r7 = r7.m5127getZero9UxMQ8M()
        L7c:
            androidx.compose.ui.unit.Velocity r7 = androidx.compose.ui.unit.Velocity.m5107boximpl(r7)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo559onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    */
    public java.lang.Object mo334onPostFlingRZ2iAVY(long r5, long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L33:
            ...
            float r2 = androidx.compose.ui.unit.Velocity.m5116getXimpl(r7)
            float r3 = androidx.compose.ui.unit.Velocity.m5117getYimpl(r7)
            ...
            return r9
        L55:
            androidx.compose.ui.unit.Velocity r9 = androidx.compose.ui.unit.Velocity.m5107boximpl(r7)
            return r9
        */
    ...
    private final float toFloat(long $this$toFloat) {
        return Offset.m2404getYimpl($this$toFloat);
    }
}
