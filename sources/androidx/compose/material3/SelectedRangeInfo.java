...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            return new SelectedRangeInfo(new Pair(IntOffset.m5000boximpl(startCoordinates), IntOffset.m5000boximpl(endCoordinates)), firstIsSelectionStart, lastIsSelectionEnd);
        }
    }
}
