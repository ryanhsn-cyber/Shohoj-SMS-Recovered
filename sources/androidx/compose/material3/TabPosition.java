...
public final class TabPosition {
    ...
    public final float m1518getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m4896equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m4896equalsimpl0(this.width, ((TabPosition) other).width);
    }

    public int hashCode() {
        int result = Dp.m4897hashCodeimpl(this.left);
        return (result * 31) + Dp.m4897hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m4902toStringimpl(this.left)) + ", right=" + ((Object) Dp.m4902toStringimpl(m1518getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m4902toStringimpl(this.width)) + ')';
    }
}
