...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo336onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m2404getYimpl(available) > 0.0f) {
            return Offset.INSTANCE.m2419getZeroF1C5BW0();
        }
        float prevHeightOffset = this.this$0.getState().getHeightOffset();
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2404getYimpl(available));
        if (!(prevHeightOffset == this.this$0.getState().getHeightOffset())) {
            return Offset.m2397copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m2419getZeroF1C5BW0();
    }
    ...
    public long mo335onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m2404getYimpl(consumed));
        if (Offset.m2404getYimpl(available) < 0.0f || Offset.m2404getYimpl(consumed) < 0.0f) {
            float oldHeightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2404getYimpl(consumed));
            return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - oldHeightOffset);
        }
        if ((Offset.m2404getYimpl(consumed) == 0.0f) && Offset.m2404getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m2404getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo334onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L59:
            ...
            float r10 = androidx.compose.ui.unit.Velocity.m5117getYimpl(r10)
        ...
        L85:
            ...
            long r10 = androidx.compose.ui.unit.Velocity.m5120plusAH228Gc(r12, r10)
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m5107boximpl(r10)
            return r10
        */
