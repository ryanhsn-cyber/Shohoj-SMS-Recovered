...
public final class TimePickerColors {
    ...
    public final long m1573periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1574periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1575timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1576timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public final long m1568clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2643equalsimpl0(this.clockDialColor, ((TimePickerColors) other).clockDialColor) && Color.m2643equalsimpl0(this.selectorColor, ((TimePickerColors) other).selectorColor) && Color.m2643equalsimpl0(this.containerColor, ((TimePickerColors) other).containerColor) && Color.m2643equalsimpl0(this.periodSelectorBorderColor, ((TimePickerColors) other).periodSelectorBorderColor) && Color.m2643equalsimpl0(this.periodSelectorSelectedContainerColor, ((TimePickerColors) other).periodSelectorSelectedContainerColor) && Color.m2643equalsimpl0(this.periodSelectorUnselectedContainerColor, ((TimePickerColors) other).periodSelectorUnselectedContainerColor) && Color.m2643equalsimpl0(this.periodSelectorSelectedContentColor, ((TimePickerColors) other).periodSelectorSelectedContentColor) && Color.m2643equalsimpl0(this.periodSelectorUnselectedContentColor, ((TimePickerColors) other).periodSelectorUnselectedContentColor) && Color.m2643equalsimpl0(this.timeSelectorSelectedContainerColor, ((TimePickerColors) other).timeSelectorSelectedContainerColor) && Color.m2643equalsimpl0(this.timeSelectorUnselectedContainerColor, ((TimePickerColors) other).timeSelectorUnselectedContainerColor) && Color.m2643equalsimpl0(this.timeSelectorSelectedContentColor, ((TimePickerColors) other).timeSelectorSelectedContentColor) && Color.m2643equalsimpl0(this.timeSelectorUnselectedContentColor, ((TimePickerColors) other).timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        int result = Color.m2649hashCodeimpl(this.clockDialColor);
        return (((((((((((((((((((((result * 31) + Color.m2649hashCodeimpl(this.selectorColor)) * 31) + Color.m2649hashCodeimpl(this.containerColor)) * 31) + Color.m2649hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m2649hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m2649hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m2649hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m2649hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m2649hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m2649hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m2649hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m2649hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
