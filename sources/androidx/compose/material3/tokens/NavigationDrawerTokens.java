...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m4891constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m4891constructorimpl((float) 336.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m1829getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m1828getLevel0D9Ej5fM();
    ...
    public final float m1981getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1982getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1983getContainerWidthD9Ej5fM() {
    ...
    public final float m1984getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m1985getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m1986getStandardContainerElevationD9Ej5fM() {
