...
public final class NavigationRailTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m4891constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m4891constructorimpl((float) 56.0d);
    ...
    private static final float ContainerWidth = Dp.m4891constructorimpl((float) 80.0d);
    ...
    private static final float MenuIconSize = Dp.m4891constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens MenuPressedIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final float NoLabelActiveIndicatorHeight = Dp.m4891constructorimpl((float) 56.0d);
    ...
    public final float m1987getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1988getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1990getContainerWidthD9Ej5fM() {
    ...
    public final float m1992getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m1993getNoLabelActiveIndicatorHeightD9Ej5fM() {
