...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m4891constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m4891constructorimpl((float) 48.0d);
    ...
    public final float m1729getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m1730getSizeD9Ej5fM() {
        return Size;
    }
}
