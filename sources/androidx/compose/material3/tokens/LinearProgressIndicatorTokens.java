...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m4891constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m4891constructorimpl((float) 4.0d);
    ...
    public final float m1957getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m1958getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
