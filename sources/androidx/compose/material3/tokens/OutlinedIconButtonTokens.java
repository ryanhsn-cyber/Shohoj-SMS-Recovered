...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m4891constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m4891constructorimpl((float) 24.0d);
    ...
    public final float m2015getContainerSizeD9Ej5fM() {
    ...
    public final float m2016getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2017getUnselectedOutlineWidthD9Ej5fM() {
