...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m3821toMotionEventScoped4ec7I(PointerEvent toMotionEventScope, long offset, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m3822toMotionEventScopeubNVwUQ(toMotionEventScope, offset, block, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I, reason: not valid java name */
    public static final void m3820toCancelMotionEventScoped4ec7I(PointerEvent toCancelMotionEventScope, long offset, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m3822toMotionEventScopeubNVwUQ(toCancelMotionEventScope, offset, block, true);
    }
    ...
    private static final void m3822toMotionEventScopeubNVwUQ(PointerEvent $this$toMotionEventScope_u2dubNVwUQ, long offset, Function1<? super MotionEvent, Unit> function1, boolean cancel) {
        ...
        motionEvent.offsetLocation(-Offset.m2403getXimpl(offset), -Offset.m2404getYimpl(offset));
