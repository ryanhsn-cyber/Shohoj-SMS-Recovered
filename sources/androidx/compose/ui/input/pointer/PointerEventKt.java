...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        ...
        return !Offset.m2400equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m2419getZeroF1C5BW0());
    }
    ...
    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        ...
        return true ^ Offset.m2400equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m2419getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        long offset = Offset.m2407minusMKHz9U(currentPosition, previousPosition);
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m2419getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        ...
        if (!Offset.m2400equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m2419getZeroF1C5BW0())) {
    ...
    public static final boolean m3707isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long size) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        long position = isOutOfBounds.getPosition();
        float x = Offset.m2403getXimpl(position);
        float y = Offset.m2404getYimpl(position);
        int width = IntSize.m5051getWidthimpl(size);
        int height = IntSize.m5050getHeightimpl(size);
        return x < 0.0f || x > ((float) width) || y < 0.0f || y > ((float) height);
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m3708isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long size, long extendedTouchPadding) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m3833equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m3840getTouchT8wyACA())) {
            return m3707isOutOfBoundsO0kMr_c(isOutOfBounds, size);
        }
        long position = isOutOfBounds.getPosition();
        float x = Offset.m2403getXimpl(position);
        float y = Offset.m2404getYimpl(position);
        float minX = -Size.m2472getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m5051getWidthimpl(size) + Size.m2472getWidthimpl(extendedTouchPadding);
        float minY = -Size.m2469getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m5050getHeightimpl(size) + Size.m2469getHeightimpl(extendedTouchPadding);
