...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m3696constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m3824constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m3702calculatePointerEventType7fucELk();
    }
    ...
    public final void m3706setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m3702calculatePointerEventType7fucELk() {
        MotionEvent motionEvent = getMotionEvent$ui_release();
        if (motionEvent != null) {
            switch (motionEvent.getActionMasked()) {
                case 0:
                case 5:
                    return PointerEventType.INSTANCE.m3719getPress7fucELk();
                case 1:
                case 6:
                    return PointerEventType.INSTANCE.m3720getRelease7fucELk();
                case 2:
                case 7:
                    return PointerEventType.INSTANCE.m3718getMove7fucELk();
                case 3:
                case 4:
                default:
                    return PointerEventType.INSTANCE.m3722getUnknown7fucELk();
                case 8:
                    return PointerEventType.INSTANCE.m3721getScroll7fucELk();
                case 9:
                    return PointerEventType.INSTANCE.m3716getEnter7fucELk();
                case 10:
                    return PointerEventType.INSTANCE.m3717getExit7fucELk();
            }
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (index$iv < size) {
            ...
            map.put(PointerId.m3742boximpl(change.getId()), change);
            ...
            if (internalPointerEvent != null) {
                ...
                z = true;
                if (internalPointerEvent.m3692issuesEnterExitEvent0FcD4WY(change.getId())) {
