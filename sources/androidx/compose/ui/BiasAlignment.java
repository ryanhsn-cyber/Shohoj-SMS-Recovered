...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2293alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m5051getWidthimpl(space) - IntSize.m5051getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m5050getHeightimpl(space) - IntSize.m5050getHeightimpl(size)) / 2.0f;
