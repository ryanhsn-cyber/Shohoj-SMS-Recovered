...
public final class IntRectKt {
    ...
    public static final IntRect m5041IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m5009getXimpl(offset), IntOffset.m5010getYimpl(offset), IntOffset.m5009getXimpl(offset) + IntSize.m5051getWidthimpl(size), IntOffset.m5010getYimpl(offset) + IntSize.m5050getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5040IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m5009getXimpl(topLeft), IntOffset.m5010getYimpl(topLeft), IntOffset.m5009getXimpl(bottomRight), IntOffset.m5010getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5042IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m5009getXimpl(center) - radius, IntOffset.m5010getYimpl(center) - radius, IntOffset.m5009getXimpl(center) + radius, IntOffset.m5010getYimpl(center) + radius);
    }
