...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m4835boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m4836constructorimpl(long j) {
        return j;
    }
    ...
    public static int m4850hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m4839equalsimpl(this.value, obj);
    }
    ...
    private static final int m4841getFocusIndeximpl(long arg0) {
        return (int) (3 & arg0);
    }

    /* renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m4849getMinWidthimpl(long arg0) {
        int mask = WidthMask[m4841getFocusIndeximpl(arg0)];
        return ((int) (arg0 >> MinFocusHeight)) & mask;
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m4847getMaxWidthimpl(long arg0) {
        int mask = WidthMask[m4841getFocusIndeximpl(arg0)];
    ...
    public static final int m4848getMinHeightimpl(long arg0) {
        int focus = m4841getFocusIndeximpl(arg0);
    ...
    public static final int m4846getMaxHeightimpl(long arg0) {
        int focus = m4841getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
    ...
    public static final boolean m4843getHasBoundedWidthimpl(long arg0) {
        int mask = WidthMask[m4841getFocusIndeximpl(arg0)];
        return (((int) (arg0 >> 33)) & mask) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m4842getHasBoundedHeightimpl(long arg0) {
        int focus = m4841getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
        int offset = MinHeightOffsets[focus] + 31;
    ...
    public static final boolean m4845getHasFixedWidthimpl(long arg0) {
        return m4847getMaxWidthimpl(arg0) == m4849getMinWidthimpl(arg0);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m4844getHasFixedHeightimpl(long arg0) {
        return m4846getMaxHeightimpl(arg0) == m4848getMinHeightimpl(arg0);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m4851isZeroimpl(long arg0) {
        return m4847getMaxWidthimpl(arg0) == 0 || m4846getMaxHeightimpl(arg0) == 0;
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m4837copyZbe2FdA(long arg0, int minWidth, int maxWidth, int minHeight, int maxHeight) {
        boolean z = true;
        ...
        return INSTANCE.m4854createConstraintsZbe2FdA$ui_unit_release(minWidth, maxWidth, minHeight, maxHeight);
    }
    ...
    public static String m4852toStringimpl(long arg0) {
        int maxWidth = m4847getMaxWidthimpl(arg0);
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? "Infinity" : String.valueOf(maxWidth);
        int maxHeight = m4846getMaxHeightimpl(arg0);
        String maxHeightStr = maxHeight != Integer.MAX_VALUE ? String.valueOf(maxHeight) : "Infinity";
        return "Constraints(minWidth = " + m4849getMinWidthimpl(arg0) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m4848getMinHeightimpl(arg0) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m4855fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m4854createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m4857fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m4854createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
            throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m4856fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m4854createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
            throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m4854createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long focus;
            ...
            return Constraints.m4836constructorimpl(value);
        }
