...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m5027getSizeYbymL2g$annotations() {
    }
    ...
    public final long m5035getSizeYbymL2g() {
    ...
    public final IntRect m5039translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5009getXimpl(offset), this.top + IntOffset.m5010getYimpl(offset), this.right + IntOffset.m5009getXimpl(offset), this.bottom + IntOffset.m5010getYimpl(offset));
    }
