...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult m3929measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    default int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height) {
        ...
        MeasureResult layoutResult = m3929measure3p2s80s(layoutReceiver, mapped, constraints);
