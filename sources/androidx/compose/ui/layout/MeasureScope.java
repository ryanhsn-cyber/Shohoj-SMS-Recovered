...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m3917roundToPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo320roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m3918roundToPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo321roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m3919toDpGaN1DYA(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo322toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3920toDpu2uoSUM(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo323toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3921toDpu2uoSUM(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo324toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m3922toDpSizekrfVVM(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo325toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m3923toPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo326toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m3924toPx0680j_4(MeasureScope $this, float $receiver) {
        ...
        public static long m3925toSizeXkaWNTQ(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo328toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m3926toSp0xMU5do(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo329toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3927toSpkPz2Gy4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo330toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3928toSpkPz2Gy4(MeasureScope $this, int $receiver) {
