...
final class FixedSizeIntrinsicsPlaceable extends Placeable {
    public FixedSizeIntrinsicsPlaceable(int width, int height) {
        m3935setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
    }
    ...
    public void mo3881placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
    }
}
