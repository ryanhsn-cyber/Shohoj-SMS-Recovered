...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.INSTANCE.m5019getZeronOccac();

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: placeAt-f8xVGno */
    public abstract void mo3881placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);
    ...
    public int getMeasuredWidth() {
        return IntSize.m5051getWidthimpl(this.measuredSize);
    }

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredHeight() {
        return IntSize.m5050getHeightimpl(this.measuredSize);
    }
    ...
    public final void m3935setMeasuredSizeozmzZPI(long value) {
        if (!IntSize.m5049equalsimpl0(this.measuredSize, value)) {
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m5051getWidthimpl(this.measuredSize), Constraints.m4849getMinWidthimpl(this.measurementConstraints), Constraints.m4847getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m5050getHeightimpl(this.measuredSize), Constraints.m4848getMinHeightimpl(this.measurementConstraints), Constraints.m4846getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m5051getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m5050getHeightimpl(this.measuredSize)) / 2);
    }
    ...
    public final void m3936setMeasurementConstraintsBRTryo0(long value) {
        if (!Constraints.m4840equalsimpl0(this.measurementConstraints, value)) {
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m3938placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3944placeRelative70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelative-70tqf50, reason: not valid java name */
        public final void m3944placeRelative70tqf50(Placeable placeRelative, long position, float zIndex) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long other$iv$iv$iv = placeRelative.apparentToRealOffset;
                placeRelative.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position) + IntOffset.m5009getXimpl(other$iv$iv$iv), IntOffset.m5010getYimpl(position) + IntOffset.m5010getYimpl(other$iv$iv$iv)), zIndex, null);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m5009getXimpl(position), IntOffset.m5010getYimpl(position));
                long other$iv$iv$iv2 = placeRelative.apparentToRealOffset;
                placeRelative.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv$iv) + IntOffset.m5009getXimpl(other$iv$iv$iv2), IntOffset.m5010getYimpl(position$iv$iv) + IntOffset.m5010getYimpl(other$iv$iv$iv2)), zIndex, null);
            }
        }
        ...
        public final void placeRelative(Placeable $this$placeRelative, int x, int y, float zIndex) {
            ...
            if (getParentLayoutDirection() != LayoutDirection.Ltr && getParentWidth() != 0) {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeRelative.getWidth()) - IntOffset.m5009getXimpl(position$iv), IntOffset.m5010getYimpl(position$iv));
                long other$iv$iv$iv = $this$placeRelative.apparentToRealOffset;
                $this$placeRelative.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv$iv) + IntOffset.m5009getXimpl(other$iv$iv$iv), IntOffset.m5010getYimpl(position$iv$iv) + IntOffset.m5010getYimpl(other$iv$iv$iv)), zIndex, null);
                return;
            }
            long other$iv$iv$iv2 = $this$placeRelative.apparentToRealOffset;
            $this$placeRelative.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv) + IntOffset.m5009getXimpl(other$iv$iv$iv2), IntOffset.m5010getYimpl(position$iv) + IntOffset.m5010getYimpl(other$iv$iv$iv2)), zIndex, null);
        }
        ...
        public final void place(Placeable $this$place, int x, int y, float zIndex) {
            ...
            $this$place.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv) + IntOffset.m5009getXimpl(other$iv$iv), IntOffset.m5010getYimpl(position$iv) + IntOffset.m5010getYimpl(other$iv$iv)), zIndex, null);
        }

        /* renamed from: place-70tqf50$default, reason: not valid java name */
        public static /* synthetic */ void m3937place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m3941place70tqf50(placeable, j, f);
        }

        /* renamed from: place-70tqf50, reason: not valid java name */
        public final void m3941place70tqf50(Placeable place, long position, float zIndex) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long other$iv$iv = place.apparentToRealOffset;
            place.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position) + IntOffset.m5009getXimpl(other$iv$iv), IntOffset.m5010getYimpl(position) + IntOffset.m5010getYimpl(other$iv$iv)), zIndex, null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m3939placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            ...
            placementScope.m3945placeRelativeWithLayeraW9wM(placeable, j, f2, function12);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m3945placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long other$iv$iv$iv = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position) + IntOffset.m5009getXimpl(other$iv$iv$iv), IntOffset.m5010getYimpl(position) + IntOffset.m5010getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
            } else {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m5009getXimpl(position), IntOffset.m5010getYimpl(position));
                long other$iv$iv$iv2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv$iv) + IntOffset.m5009getXimpl(other$iv$iv$iv2), IntOffset.m5010getYimpl(position$iv$iv) + IntOffset.m5010getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
            }
        }
        ...
        public final void placeRelativeWithLayer(Placeable $this$placeRelativeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            long position$iv = IntOffsetKt.IntOffset(x, y);
            if (getParentLayoutDirection() != LayoutDirection.Ltr && getParentWidth() != 0) {
                long position$iv$iv = IntOffsetKt.IntOffset((getParentWidth() - $this$placeRelativeWithLayer.getWidth()) - IntOffset.m5009getXimpl(position$iv), IntOffset.m5010getYimpl(position$iv));
                long other$iv$iv$iv = $this$placeRelativeWithLayer.apparentToRealOffset;
                $this$placeRelativeWithLayer.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv$iv) + IntOffset.m5009getXimpl(other$iv$iv$iv), IntOffset.m5010getYimpl(position$iv$iv) + IntOffset.m5010getYimpl(other$iv$iv$iv)), zIndex, layerBlock);
                return;
            }
            long other$iv$iv$iv2 = $this$placeRelativeWithLayer.apparentToRealOffset;
            $this$placeRelativeWithLayer.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv) + IntOffset.m5009getXimpl(other$iv$iv$iv2), IntOffset.m5010getYimpl(position$iv) + IntOffset.m5010getYimpl(other$iv$iv$iv2)), zIndex, layerBlock);
        }
        ...
        public final void placeWithLayer(Placeable $this$placeWithLayer, int x, int y, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            $this$placeWithLayer.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv) + IntOffset.m5009getXimpl(other$iv$iv), IntOffset.m5010getYimpl(position$iv) + IntOffset.m5010getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* renamed from: placeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m3940placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            float f2;
            Function1 function12;
            if (obj != null) {
            ...
            placementScope.m3946placeWithLayeraW9wM(placeable, j, f2, function12);
        }

        /* renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m3946placeWithLayeraW9wM(Placeable placeWithLayer, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long other$iv$iv = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position) + IntOffset.m5009getXimpl(other$iv$iv), IntOffset.m5010getYimpl(position) + IntOffset.m5010getYimpl(other$iv$iv)), zIndex, layerBlock);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m3943placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeAutoMirrored.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position) + IntOffset.m5009getXimpl(other$iv$iv), IntOffset.m5010getYimpl(position) + IntOffset.m5010getYimpl(other$iv$iv)), zIndex, function1);
            } else {
                long position$iv = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m5009getXimpl(position), IntOffset.m5010getYimpl(position));
                long other$iv$iv2 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position$iv) + IntOffset.m5009getXimpl(other$iv$iv2), IntOffset.m5010getYimpl(position$iv) + IntOffset.m5010getYimpl(other$iv$iv2)), zIndex, function1);
            }
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m3942placeApparentToRealOffsetaW9wM$ui_release(Placeable placeApparentToRealOffset, long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo3881placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5009getXimpl(position) + IntOffset.m5009getXimpl(other$iv), IntOffset.m5010getYimpl(position) + IntOffset.m5010getYimpl(other$iv)), zIndex, function1);
        }
