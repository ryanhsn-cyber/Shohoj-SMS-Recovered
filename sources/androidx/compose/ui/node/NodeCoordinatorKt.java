...
public final class NodeCoordinatorKt {
    ...
    public static final /* synthetic */ Modifier.Node m4091access$nextUntilhw7D004(DelegatableNode $receiver, int type, int stopType) {
        return m4092nextUntilhw7D004($receiver, type, stopType);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: nextUntil-hw7D004, reason: not valid java name */
    public static final Modifier.Node m4092nextUntilhw7D004(DelegatableNode $this$nextUntil_u2dhw7D004, int type, int stopType) {
