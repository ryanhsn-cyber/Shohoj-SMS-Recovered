...
public final class LayerPositionalProperties {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m3027getCenterSzJe1aQ();
    ...
    public final void copyFrom(GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo2828getTransformOriginSzJe1aQ();
    }
                        ...
                        if (this.rotationX == other.rotationX) {
                            if (this.rotationY == other.rotationY) {
                                if (this.rotationZ == other.rotationZ) {
                                    if ((this.cameraDistance == other.cameraDistance) && TransformOrigin.m3021equalsimpl0(this.transformOrigin, other.transformOrigin)) {
                                        return true;
                                    }
                                }
                            }
