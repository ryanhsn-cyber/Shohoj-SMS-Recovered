...
public final class AndroidPath implements Path {
    ...
    public int mo2535getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m2919getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m2920getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo2537setFillTypeoQ8Xj4U(int value) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2915equalsimpl0(value, PathFillType.INSTANCE.m2919getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m2378getXimpl(roundRect.m2453getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m2379getYimpl(roundRect.m2453getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m2378getXimpl(roundRect.m2454getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m2379getYimpl(roundRect.m2454getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m2378getXimpl(roundRect.m2452getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m2379getYimpl(roundRect.m2452getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m2378getXimpl(roundRect.m2451getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m2379getYimpl(roundRect.m2451getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA, reason: not valid java name */
    public void mo2534addPathUv8p0NA(Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m2403getXimpl(offset), Offset.m2404getYimpl(offset));
            return;
        }
    ...
    public void mo2539translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m2403getXimpl(offset), Offset.m2404getYimpl(offset));
        this.internalPath.transform(this.mMatrix);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: transform-58bKbWc, reason: not valid java name */
    public void mo2538transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        AndroidMatrixConversions_androidKt.m2514setFromEL8BTi8(this.mMatrix, matrix);
        this.internalPath.transform(this.mMatrix);
    }
    ...
    public boolean mo2536opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m2924equalsimpl0(operation, PathOperation.INSTANCE.m2928getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m2924equalsimpl0(operation, PathOperation.INSTANCE.m2929getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m2924equalsimpl0(operation, PathOperation.INSTANCE.m2930getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m2924equalsimpl0(operation, PathOperation.INSTANCE.m2931getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
