...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2528setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int mode) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3039setBlendModeGB0RdKg(setNativeBlendMode, mode);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2496toPorterDuffModes9anfk8(mode)));
        }
    }
    ...
    public static final void m2529setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long value) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m2696toArgb8_81llA(value));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m2533setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int value) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m2900equalsimpl0(value, PaintingStyle.INSTANCE.m2905getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint $this$getNativeStyle) {
        ...
        return (style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1 ? PaintingStyle.INSTANCE.m2905getStrokeTiuSbCo() : PaintingStyle.INSTANCE.m2904getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint $this$getNativeStrokeCap) {
        ...
        switch (strokeCap == null ? -1 : WhenMappings.$EnumSwitchMapping$1[strokeCap.ordinal()]) {
            case 1:
                return StrokeCap.INSTANCE.m2989getButtKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m2990getRoundKaPHkGw();
            case 3:
                return StrokeCap.INSTANCE.m2991getSquareKaPHkGw();
            default:
                return StrokeCap.INSTANCE.m2989getButtKaPHkGw();
        }
    }
    ...
    public static final void m2531setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int value) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m2985equalsimpl0(value, StrokeCap.INSTANCE.m2991getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m2985equalsimpl0(value, StrokeCap.INSTANCE.m2990getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m2985equalsimpl0(value, StrokeCap.INSTANCE.m2989getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint $this$getNativeStrokeJoin) {
        ...
        switch (strokeJoin == null ? -1 : WhenMappings.$EnumSwitchMapping$2[strokeJoin.ordinal()]) {
            case 1:
                return StrokeJoin.INSTANCE.m3000getMiterLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m2999getBevelLxFBmk8();
            case 3:
                return StrokeJoin.INSTANCE.m3001getRoundLxFBmk8();
            default:
                return StrokeJoin.INSTANCE.m3000getMiterLxFBmk8();
        }
    }
    ...
    public static final void m2532setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int value) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m2995equalsimpl0(value, StrokeJoin.INSTANCE.m3000getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m2995equalsimpl0(value, StrokeJoin.INSTANCE.m2999getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m2995equalsimpl0(value, StrokeJoin.INSTANCE.m3001getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint $this$getNativeFilterQuality) {
        ...
        if (!$this$getNativeFilterQuality.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m2741getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m2739getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m2530setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int value) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m2734equalsimpl0(value, FilterQuality.INSTANCE.m2741getNonefv9h1I()));
    }
