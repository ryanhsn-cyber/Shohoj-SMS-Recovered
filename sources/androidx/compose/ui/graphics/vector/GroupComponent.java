...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m2868constructorimpl$default(null, 1, null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m2877resetimpl(matrix);
        }
        Matrix.m2888translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m2880rotateZimpl(matrix, this.rotation);
        Matrix.m2881scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2888translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3111getSizeNHjbRc();
        ...
        if (fArr != null) {
            float[] it = (fArr != null ? Matrix.m2866boximpl(fArr) : null).m2889unboximpl();
            $this$draw_u24lambda_u245.mo3119transform58bKbWc(it);
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.m3236clipPathmtrdDE$default($this$draw_u24lambda_u245, targetClip, 0, 2, null);
        }
        List $this$fastForEach$iv = this.children;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
        ...
        $this$withTransform_u24lambda_u246$iv.mo3112setSizeuvyYCjk(previousSize$iv);
    }
