...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m2989getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m3000getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m3251getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m3252getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (this.width == ((Stroke) other).width) {
            return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m2985equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m2995equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m2986hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2996hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2987toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2997toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
