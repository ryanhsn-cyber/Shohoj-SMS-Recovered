...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m2515setFromtUYjHk(float[] setFrom, android.graphics.Matrix matrix) {
    ...
    */
    public static final void m2514setFromEL8BTi8(android.graphics.Matrix r24, float[] r25) {
        /*
            Method dump skipped, instructions count: 244
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.AndroidMatrixConversions_androidKt.m2514setFromEL8BTi8(android.graphics.Matrix, float[]):void");
    }
}
