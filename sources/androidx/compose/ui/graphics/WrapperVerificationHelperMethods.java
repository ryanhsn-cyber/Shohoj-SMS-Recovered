...
public final class WrapperVerificationHelperMethods {
    ...
    public final void m3039setBlendModeGB0RdKg(android.graphics.Paint paint, int mode) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        paint.setBlendMode(AndroidBlendMode_androidKt.m2495toAndroidBlendModes9anfk8(mode));
    }
}
