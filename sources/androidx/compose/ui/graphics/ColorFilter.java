...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2683tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m2584getSrcIn0nO6VwU();
            }
            return companion.m2686tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m2686tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m2510actualTintColorFilterxETnrds(color, blendMode);
        }

        /* renamed from: colorMatrix-jHG-Opc, reason: not valid java name */
        public final ColorFilter m2684colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m2508actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI, reason: not valid java name */
        public final ColorFilter m2685lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m2509actualLightingColorFilterOWjLjI(multiply, add);
        }
    }
