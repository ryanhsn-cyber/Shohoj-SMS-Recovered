    ...
    */
    public /* synthetic */ BlurEffect(androidx.compose.ui.graphics.RenderEffect r7, float r8, float r9, int r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        L7:
            ...
            int r10 = r9.m3009getClamp3opZhB0()
            r4 = r10
            goto L14
        L13:
            r4 = r10
    ...
    protected android.graphics.RenderEffect getAndroidRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m2946createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.radiusX == ((BlurEffect) other).radiusX) {
            return ((this.radiusY > ((BlurEffect) other).radiusY ? 1 : (this.radiusY == ((BlurEffect) other).radiusY ? 0 : -1)) == 0) && TileMode.m3005equalsimpl0(this.edgeTreatment, ((BlurEffect) other).edgeTreatment) && Intrinsics.areEqual(this.renderEffect, ((BlurEffect) other).renderEffect);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Float.hashCode(this.radiusX)) * 31) + Float.hashCode(this.radiusY)) * 31) + TileMode.m3006hashCodeimpl(this.edgeTreatment);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + ((Object) TileMode.m3007toStringimpl(this.edgeTreatment)) + ')';
    }
}
