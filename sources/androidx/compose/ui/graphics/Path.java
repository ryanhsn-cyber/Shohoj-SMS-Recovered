...
public interface Path {
    ...
    void mo2534addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo2536opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo2537setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M */
    void mo2539translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2910transform58bKbWc(Path $this, float[] matrix) {
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            Path.super.mo2538transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m2907addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: addPath-Uv8p0NA");
        }
        if ((i & 2) != 0) {
            j = Offset.INSTANCE.m2419getZeroF1C5BW0();
        }
        path.mo2534addPathUv8p0NA(path2, j);
    }
    ...
    default void mo2538transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
    }
    ...
    public static final class Companion {
        ...
        public final Path m2908combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path path = AndroidPath_androidKt.Path();
            if (path.mo2536opN5in7k0(path1, path2, operation)) {
                return path;
            }
