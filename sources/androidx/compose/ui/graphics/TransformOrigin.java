...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m3014boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3017constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3020equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3021equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m3024hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m3020equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3024hashCodeimpl(this.packedValue);
    }
    ...
    public static final float m3022getPivotFractionXimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m3023getPivotFractionYimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (4294967295L & arg0));
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m3015component1impl(long arg0) {
        return m3022getPivotFractionXimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3016component2impl(long arg0) {
        return m3023getPivotFractionYimpl(arg0);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m3019copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m3022getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m3023getPivotFractionYimpl(j);
        }
        return m3018copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m3018copyzey9I6w(long arg0, float pivotFractionX, float pivotFractionY) {
    ...
    public static final class Companion {
        ...
        public final long m3027getCenterSzJe1aQ() {
