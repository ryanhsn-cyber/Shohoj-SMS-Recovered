...
public final class AndroidPathMeasure implements PathMeasure {
    ...
    public long mo2542getPositiontuRUvjQ(float distance) {
        ...
        return Offset.INSTANCE.m2418getUnspecifiedF1C5BW0();
    }

    @Override // androidx.compose.ui.graphics.PathMeasure
    /* renamed from: getTangent-tuRUvjQ, reason: not valid java name */
    public long mo2543getTangenttuRUvjQ(float distance) {
        if (this.positionArray == null) {
            this.positionArray = new float[2];
        }
        if (this.tangentArray == null) {
