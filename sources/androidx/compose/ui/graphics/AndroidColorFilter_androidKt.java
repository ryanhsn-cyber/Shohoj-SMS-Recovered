...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2510actualTintColorFilterxETnrds(long color, int blendMode) {
        PorterDuffColorFilter androidColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m2588BlendModeColorFilterxETnrds(color, blendMode);
        } else {
            androidColorFilter = new PorterDuffColorFilter(ColorKt.m2696toArgb8_81llA(color), AndroidBlendMode_androidKt.m2496toPorterDuffModes9anfk8(blendMode));
        }
        return new ColorFilter(androidColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final ColorFilter m2508actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final ColorFilter m2509actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m2696toArgb8_81llA(multiply), ColorKt.m2696toArgb8_81llA(add)));
    }
}
