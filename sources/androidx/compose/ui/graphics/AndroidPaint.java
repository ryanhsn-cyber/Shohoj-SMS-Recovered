...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2586getSrcOver0nO6VwU();
    }
    ...
    public long mo2517getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2523setColor8_81llA(long color) {
        AndroidPaint_androidKt.m2529setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo2522setBlendModes9anfk8(int value) {
        if (!BlendMode.m2555equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m2528setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2521getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo2527setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m2533setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo2519getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo2525setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m2531setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2520getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2526setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m2532setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo2518getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo2524setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m2530setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
