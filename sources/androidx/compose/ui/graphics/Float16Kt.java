...
public final class Float16Kt {
    ...
    public static final short m2786minAoSsdG0(short x, short y) {
        if (Float16.m2758isNaNimpl(x) || Float16.m2758isNaNimpl(y)) {
            return Float16.INSTANCE.m2780getNaNslo4al4();
        }
        return Float16.m2745compareTo41bOqos(x, y) <= 0 ? x : y;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m2785maxAoSsdG0(short x, short y) {
        if (Float16.m2758isNaNimpl(x) || Float16.m2758isNaNimpl(y)) {
            return Float16.INSTANCE.m2780getNaNslo4al4();
        }
        return Float16.m2745compareTo41bOqos(x, y) >= 0 ? x : y;
