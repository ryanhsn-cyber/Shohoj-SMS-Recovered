...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo2611createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m2480getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo2589applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2468equalsimpl0(this.createdSize, size)) {
            if (Size.m2474isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m2480getUnspecifiedNHjbRc();
            } else {
                Shader it = mo2611createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m2643equalsimpl0(p.mo2517getColor0d7_KjU(), Color.INSTANCE.m2668getBlack0d7_KjU())) {
            p.mo2523setColor8_81llA(Color.INSTANCE.m2668getBlack0d7_KjU());
        }
