...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2293alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long remaining = IntSizeKt.IntSize(IntSize.m5051getWidthimpl(space) - IntSize.m5051getWidthimpl(size), IntSize.m5050getHeightimpl(space) - IntSize.m5050getHeightimpl(size));
        float centerX = IntSize.m5051getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m5050getHeightimpl(remaining) / 2.0f;
        float f = 1;
