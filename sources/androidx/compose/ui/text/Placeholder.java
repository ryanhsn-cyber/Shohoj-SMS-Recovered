...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (!(!TextUnitKt.m5090isUnspecifiedR2X_6o(this.width))) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (!(!TextUnitKt.m5090isUnspecifiedR2X_6o(this.height))) {
    ...
    public final Placeholder m4341copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Placeholder) && TextUnit.m5069equalsimpl0(this.width, ((Placeholder) other).width) && TextUnit.m5069equalsimpl0(this.height, ((Placeholder) other).height) && PlaceholderVerticalAlign.m4348equalsimpl0(this.placeholderVerticalAlign, ((Placeholder) other).placeholderVerticalAlign);
    }

    public int hashCode() {
        int result = TextUnit.m5073hashCodeimpl(this.width);
        return (((result * 31) + TextUnit.m5073hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m4349hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m5079toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m5079toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m4350toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
