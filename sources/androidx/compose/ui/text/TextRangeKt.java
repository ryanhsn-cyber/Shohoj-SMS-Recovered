...
public final class TextRangeKt {
    ...
    public static final String m4428substringFDrldGo(CharSequence substring, long range) {
        Intrinsics.checkNotNullParameter(substring, "$this$substring");
        return substring.subSequence(TextRange.m4419getMinimpl(range), TextRange.m4418getMaximpl(range)).toString();
    }

    public static final long TextRange(int start, int end) {
        return TextRange.m4410constructorimpl(packWithCheck(start, end));
    }
    ...
    public static final long m4427coerceIn8ffj60Q(long $this$coerceIn_u2d8ffj60Q, int minimumValue, int maximumValue) {
        int newStart = RangesKt.coerceIn(TextRange.m4421getStartimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        int newEnd = RangesKt.coerceIn(TextRange.m4416getEndimpl($this$coerceIn_u2d8ffj60Q), minimumValue, maximumValue);
        if (newStart != TextRange.m4421getStartimpl($this$coerceIn_u2d8ffj60Q) || newEnd != TextRange.m4416getEndimpl($this$coerceIn_u2d8ffj60Q)) {
