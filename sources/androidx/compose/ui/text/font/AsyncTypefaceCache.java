...
public final class AsyncTypefaceCache {
    private final Object PermanentFailure = AsyncTypefaceResult.m4474constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m4473boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Object m4474constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4475equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m4480unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4476equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4477hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static String m4479toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m4475equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m4477hashCodeimpl(this.result);
        }

        public String toString() {
            return m4479toStringimpl(this.result);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Object m4480unboximpl() {
            return this.result;
        }
        ...
        public static final boolean m4478isPermanentFailureimpl(Object arg0) {
            return arg0 == null;
        }
    }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (lock$iv) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m4473boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m4473boximpl(AsyncTypefaceResult.m4474constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m4473boximpl(AsyncTypefaceResult.m4474constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m4472get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    */
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r8, androidx.compose.ui.text.font.PlatformFontLoader r9, boolean r10, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<java.lang.Object> r12) {
        ...
        L3f:
            ...
            monitor-enter(r8)
            r4 = 0
            androidx.compose.ui.text.caches.LruCache<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r5 = r2.resultCache     // Catch: java.lang.Throwable -> Lbe
            java.lang.Object r5 = r5.get(r9)     // Catch: java.lang.Throwable -> Lbe
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r5 = (androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult) r5     // Catch: java.lang.Throwable -> Lbe
            if (r5 != 0) goto L64
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r5 = r2.permanentCache     // Catch: java.lang.Throwable -> Lbe
            java.lang.Object r5 = r5.get(r9)     // Catch: java.lang.Throwable -> Lbe
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r5 = (androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult) r5     // Catch: java.lang.Throwable -> Lbe
        L64:
            if (r5 == 0) goto L6c
            java.lang.Object r9 = r5.m4480unboximpl()     // Catch: java.lang.Throwable -> Lbe
            monitor-exit(r8)
            return r9
        L6c:
        ...
        L80:
            ...
            r5 = 0
            if (r11 != 0) goto L98
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.permanentCache     // Catch: java.lang.Throwable -> L96
            java.lang.Object r11 = r2.PermanentFailure     // Catch: java.lang.Throwable -> L96
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r11 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4473boximpl(r11)     // Catch: java.lang.Throwable -> L96
            r10.put(r9, r11)     // Catch: java.lang.Throwable -> L96
            goto Lb6
        L96:
            r8 = move-exception
            goto Lbc
        L98:
            if (r10 == 0) goto La9
            androidx.compose.ui.text.caches.SimpleArrayMap<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.permanentCache     // Catch: java.lang.Throwable -> L96
            java.lang.Object r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4474constructorimpl(r11)     // Catch: java.lang.Throwable -> L96
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4473boximpl(r6)     // Catch: java.lang.Throwable -> L96
            r10.put(r9, r6)     // Catch: java.lang.Throwable -> L96
            goto Lb6
        La9:
            androidx.compose.ui.text.caches.LruCache<androidx.compose.ui.text.font.AsyncTypefaceCache$Key, androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult> r10 = r2.resultCache     // Catch: java.lang.Throwable -> L96
            java.lang.Object r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4474constructorimpl(r11)     // Catch: java.lang.Throwable -> L96
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r6 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4473boximpl(r6)     // Catch: java.lang.Throwable -> L96
            r10.put(r9, r6)     // Catch: java.lang.Throwable -> L96
        Lb6:
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        ...
        synchronized (lock$iv) {
            try {
                ...
                if (priorResult != null) {
                    Object m4480unboximpl = priorResult.m4480unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return m4480unboximpl;
                }
