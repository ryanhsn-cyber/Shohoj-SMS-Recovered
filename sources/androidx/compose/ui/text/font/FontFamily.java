...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        State<Object> mo4491resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis);

        /* renamed from: resolve-DPcqOEQ$default, reason: not valid java name */
        static /* synthetic */ State m4490resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            if ((i3 & 4) != 0) {
                i = FontStyle.INSTANCE.m4521getNormal_LCdwA();
            }
            if ((i3 & 8) != 0) {
                i2 = FontSynthesis.INSTANCE.m4531getAllGVVA2EU();
            }
            return resolver.mo4491resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        }
    }
