...
public final class FontSynthesis {
    ...
    private static final int None = m4523constructorimpl(0);
    private static final int All = m4523constructorimpl(1);
    private static final int Weight = m4523constructorimpl(2);
    private static final int Style = m4523constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontSynthesis m4522boximpl(int i) {
    ...
    public static String m4529toStringimpl(int arg0) {
        return m4525equalsimpl0(arg0, None) ? "None" : m4525equalsimpl0(arg0, All) ? "All" : m4525equalsimpl0(arg0, Weight) ? "Weight" : m4525equalsimpl0(arg0, Style) ? "Style" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4532getNoneGVVA2EU() {
            return FontSynthesis.None;
        }

        /* renamed from: getAll-GVVA2EU, reason: not valid java name */
        public final int m4531getAllGVVA2EU() {
            return FontSynthesis.All;
        }

        /* renamed from: getWeight-GVVA2EU, reason: not valid java name */
        public final int m4534getWeightGVVA2EU() {
            return FontSynthesis.Weight;
        }

        /* renamed from: getStyle-GVVA2EU, reason: not valid java name */
        public final int m4533getStyleGVVA2EU() {
            return FontSynthesis.Style;
        }
    }

    /* renamed from: isWeightOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m4528isWeightOnimpl$ui_text_release(int arg0) {
        return m4525equalsimpl0(arg0, All) || m4525equalsimpl0(arg0, Weight);
    }

    /* renamed from: isStyleOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m4527isStyleOnimpl$ui_text_release(int arg0) {
        return m4525equalsimpl0(arg0, All) || m4525equalsimpl0(arg0, Style);
    }
}
