...
final class Font extends AndroidFont {
    ...
    private Font(String familyName, FontWeight weight, int style, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.INSTANCE.m4509getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, null);
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo4543optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), getStyle(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Font) && DeviceFontFamilyName.m4484equalsimpl0(this.familyName, ((Font) other).familyName) && Intrinsics.areEqual(getWeight(), ((Font) other).getWeight()) && FontStyle.m4516equalsimpl0(getStyle(), ((Font) other).getStyle()) && Intrinsics.areEqual(getVariationSettings(), ((Font) other).getVariationSettings());
    }

    public int hashCode() {
        int result = DeviceFontFamilyName.m4485hashCodeimpl(this.familyName);
        return (((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m4517hashCodeimpl(getStyle())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m4486toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4518toStringimpl(getStyle())) + ')';
    }
}
