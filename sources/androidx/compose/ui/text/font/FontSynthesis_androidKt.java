...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m4535synthesizeTypefaceFxwP2eA(int $this$synthesizeTypeface_u2dFxwP2eA, Object typeface, Font font, FontWeight requestedWeight, int requestedStyle) {
        int finalFontWeight;
        ...
        boolean synthesizeWeight = FontSynthesis.m4528isWeightOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !Intrinsics.areEqual(font.getWeight(), requestedWeight) && requestedWeight.compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) >= 0 && font.getWeight().compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) < 0;
        boolean synthesizeStyle = FontSynthesis.m4527isStyleOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !FontStyle.m4516equalsimpl0(requestedStyle, font.getStyle());
        if (!synthesizeStyle && !synthesizeWeight) {
            return typeface;
        }
        if (Build.VERSION.SDK_INT < 28) {
            int targetStyle = AndroidFontUtils_androidKt.getAndroidTypefaceStyle(synthesizeWeight, synthesizeStyle && FontStyle.m4516equalsimpl0(requestedStyle, FontStyle.INSTANCE.m4520getItalic_LCdwA()));
            ...
            if (synthesizeStyle) {
                finalFontStyle = FontStyle.m4516equalsimpl0(requestedStyle, FontStyle.INSTANCE.m4520getItalic_LCdwA());
            } else {
                finalFontStyle = FontStyle.m4516equalsimpl0(font.getStyle(), FontStyle.INSTANCE.m4520getItalic_LCdwA());
            }
