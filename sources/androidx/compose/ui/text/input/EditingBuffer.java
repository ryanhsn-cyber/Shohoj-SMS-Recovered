...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m4419getMinimpl(selection);
        this.selectionEnd = TextRange.m4418getMaximpl(selection);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int start = TextRange.m4419getMinimpl(selection);
        int end = TextRange.m4418getMaximpl(selection);
    ...
    public final TextRange m4561getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4409boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release, reason: not valid java name */
    public final long m4562getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m4563updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m4419getMinimpl(newSelection));
        setSelectionEnd(TextRange.m4418getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m4563updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
            if (TextRange.m4415getCollapsedimpl(newComposition)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m4419getMinimpl(newComposition);
                this.compositionEnd = TextRange.m4418getMaximpl(newComposition);
            }
        }
    }
