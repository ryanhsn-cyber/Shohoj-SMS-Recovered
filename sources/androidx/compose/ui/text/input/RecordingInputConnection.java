...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int compositionStart = composition != null ? TextRange.m4419getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            int compositionEnd = composition2 != null ? TextRange.m4418getMaximpl(composition2.getPackedValue()) : -1;
            inputMethodManager.updateSelection(TextRange.m4419getMinimpl(state.getSelection()), TextRange.m4418getMaximpl(state.getSelection()), compositionStart, compositionEnd);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4415getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        if (applying$iv) {
            switch (editorAction) {
                case 0:
                    imeAction = ImeAction.INSTANCE.m4579getDefaulteUduSuo();
                    break;
                case 1:
                default:
                    ...
                    break;
                case 2:
                    imeAction = ImeAction.INSTANCE.m4581getGoeUduSuo();
                    break;
                case 3:
                    imeAction = ImeAction.INSTANCE.m4585getSearcheUduSuo();
                    break;
                case 4:
                    imeAction = ImeAction.INSTANCE.m4586getSendeUduSuo();
                    break;
                case 5:
                    imeAction = ImeAction.INSTANCE.m4582getNexteUduSuo();
                    break;
                case 6:
                    imeAction = ImeAction.INSTANCE.m4580getDoneeUduSuo();
                    break;
                case 7:
                    imeAction = ImeAction.INSTANCE.m4584getPreviouseUduSuo();
                    break;
            }
            this.eventCallback.mo4593onImeActionKlQnJC8(imeAction);
            return true;
        }
        return applying$iv;
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4419getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
