...
public final class RectKt {
    ...
    public static final Rect m2443Recttz77jQw(long offset, long size) {
        return new Rect(Offset.m2403getXimpl(offset), Offset.m2404getYimpl(offset), Offset.m2403getXimpl(offset) + Size.m2472getWidthimpl(size), Offset.m2404getYimpl(offset) + Size.m2469getHeightimpl(size));
    }

    /* renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m2441Rect0a9Yr6o(long topLeft, long bottomRight) {
        return new Rect(Offset.m2403getXimpl(topLeft), Offset.m2404getYimpl(topLeft), Offset.m2403getXimpl(bottomRight), Offset.m2404getYimpl(bottomRight));
    }

    /* renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m2442Rect3MmeM6k(long center, float radius) {
        return new Rect(Offset.m2403getXimpl(center) - radius, Offset.m2404getYimpl(center) - radius, Offset.m2403getXimpl(center) + radius, Offset.m2404getYimpl(center) + radius);
    }
