...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m2372constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m2389lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m2378getXimpl(start), CornerRadius.m2378getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m2379getYimpl(start), CornerRadius.m2379getYimpl(stop), fraction));
    }
}
