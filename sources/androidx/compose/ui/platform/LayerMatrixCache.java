...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m4215calculateMatrixGrdbGEg(T target) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m2868constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
        ...
        if (prevMatrix == null || !Intrinsics.areEqual(it2, prevMatrix)) {
            AndroidMatrixConversions_androidKt.m2515setFromtUYjHk(it, it2);
    ...
    public final float[] m4214calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m4215calculateMatrixGrdbGEg(target);
            this.isInverseValid = InvertMatrixKt.m4212invertToJiSxe2E(normalMatrix, it);
