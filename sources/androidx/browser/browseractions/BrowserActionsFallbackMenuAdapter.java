...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (menuItem.getIconId() != 0) {
            Drawable drawable = ResourcesCompat.getDrawable(this.mContext.getResources(), menuItem.getIconId(), null);
            ...
            bitmapFuture.addListener(new Runnable() { // from class: androidx.browser.browseractions.BrowserActionsFallbackMenuAdapter.1
