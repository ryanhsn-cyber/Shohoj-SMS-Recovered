...
public final class MethodDescriptor<ReqT, RespT> {
    ...
    public static String generateFullMethodName(String fullServiceName, String methodName) {
        return ((String) Preconditions.checkNotNull(fullServiceName, "fullServiceName")) + DomExceptionUtils.SEPARATOR + ((String) Preconditions.checkNotNull(methodName, "methodName"));
    }
