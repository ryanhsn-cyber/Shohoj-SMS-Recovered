...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo6808minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo6809minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo6810plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m6812minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo6810plusLRDsOJo(Duration.m6870unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m6816compareToLRDsOJo($this.mo6809minusUwyO8pc(other), Duration.INSTANCE.m6920getZEROUwyO8pc());
        }
    }
}
