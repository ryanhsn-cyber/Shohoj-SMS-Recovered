...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo6808minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m6954minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo6807elapsedNowUwyO8pc() {
        return Duration.m6852minusLRDsOJo(this.mark.mo6807elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo6810plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m6853plusLRDsOJo(this.adjustment, duration), null);
    }
}
