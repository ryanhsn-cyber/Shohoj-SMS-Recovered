...
public interface TimeMark {
    ...
    TimeMark mo6808minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6810plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m6955plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m6954minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo6810plusLRDsOJo(Duration.m6870unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m6850isNegativeimpl($this.mo6807elapsedNowUwyO8pc());
        }
