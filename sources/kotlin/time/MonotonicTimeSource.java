...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m6957boximpl(m6951markNowz9LOYto());
    }
    ...
    public long m6951markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m6960constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m6950elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m6949differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m6948adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m6960constructorimpl(LongSaturatedMathKt.m6946saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
