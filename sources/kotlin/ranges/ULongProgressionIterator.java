...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    */
    private ULongProgressionIterator(long r4, long r6, long r8) {
        ...
        L1c:
            r3.hasNext = r1
            long r0 = kotlin.ULong.m5665constructorimpl(r8)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m5659boximpl(m6726nextsVKNKU());
    }
    ...
    public long m6726nextsVKNKU() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = ULong.m5665constructorimpl(this.next + this.step);
        }
        return value;
    }
}
