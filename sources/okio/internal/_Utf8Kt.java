                        ...
                        if (endIndex <= index$iv + 2) {
                            ...
                            if ((b1$iv$iv3 & 192) == 128) {
                                ...
                                if ((b2$iv$iv2 & 192) == 128) {
                                    int codePoint$iv$iv2 = (((-123008) ^ b2$iv$iv2) ^ (b1$iv$iv3 << 6)) ^ (b0$iv$iv2 << Ascii.FF);
                            ...
                            if (endIndex <= index$iv + 3) {
                                ...
                                if ((b1$iv$iv4 & 192) == 128) {
                                    ...
                                    if ((b2$iv$iv3 & 192) == 128) {
                                        ...
                                        if ((b3$iv$iv & 192) == 128) {
                                            int codePoint$iv$iv3 = (((3678080 ^ b3$iv$iv) ^ (b2$iv$iv3 << 6)) ^ (b1$iv$iv4 << Ascii.FF)) ^ (b0$iv$iv3 << Ascii.DC2);
