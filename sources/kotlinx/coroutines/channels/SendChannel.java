...
public interface SendChannel<E> {
    ...
    Object mo6993trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo6993trySendJP2dKIU(e);
            if (ChannelResult.m7013isSuccessimpl(result)) {
                return true;
            }
            Throwable m7007exceptionOrNullimpl = ChannelResult.m7007exceptionOrNullimpl(result);
