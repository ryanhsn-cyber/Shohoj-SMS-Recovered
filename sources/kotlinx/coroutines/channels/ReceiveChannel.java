...
public interface ReceiveChannel<E> {
    ...
    Object mo6997receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo6998tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo6998tryReceivePtdJZtk = receiveChannel.mo6998tryReceivePtdJZtk();
            if (ChannelResult.m7013isSuccessimpl(mo6998tryReceivePtdJZtk)) {
                return (E) ChannelResult.m7009getOrThrowimpl(mo6998tryReceivePtdJZtk);
            }
            Throwable m7007exceptionOrNullimpl = ChannelResult.m7007exceptionOrNullimpl(mo6998tryReceivePtdJZtk);
            if (m7007exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m7007exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo6997receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m7008getOrNullimpl(r3)
                return r3
            */
