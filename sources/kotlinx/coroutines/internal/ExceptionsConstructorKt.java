...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5491constructorimpl = Result.m5491constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m5491constructorimpl = Result.m5491constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m5497isFailureimpl(m5491constructorimpl)) {
                m5491constructorimpl = null;
            }
            return (E) m5491constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    m5491constructorimpl = Result.m5491constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m5491constructorimpl = Result.m5491constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m5497isFailureimpl(m5491constructorimpl) ? null : m5491constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m5491constructorimpl = Result.m5491constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5491constructorimpl = Result.m5491constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5497isFailureimpl(m5491constructorimpl)) {
            m5491constructorimpl = valueOf;
        }
        return ((Number) m5491constructorimpl).intValue();
    }
