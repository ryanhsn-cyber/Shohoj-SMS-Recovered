...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m5491constructorimpl = Result.m5491constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5491constructorimpl = Result.m5491constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5494exceptionOrNullimpl(m5491constructorimpl) != null) {
            m5491constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) m5491constructorimpl;
    }
