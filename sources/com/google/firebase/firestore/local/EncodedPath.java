...
public final class EncodedPath {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <B extends BasePath<B>> String encode(B path) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static ResourcePath decodeResourcePath(String path) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String prefixSuccessor(String path) {
