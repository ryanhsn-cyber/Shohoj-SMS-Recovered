...
public final class ResourcePath extends BasePath<ResourcePath> {
    ...
    ResourcePath createPathWithSegments2(List<String> segments) {
    ...
    public static ResourcePath fromString(String path) {
        ...
        String[] rawSegments = path.split(DomExceptionUtils.SEPARATOR);
    ...
    public String canonicalString() {
        ...
        for (int i = 0; i < this.segments.size(); i++) {
            if (i > 0) {
                builder.append(DomExceptionUtils.SEPARATOR);
            }
