...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int minApkVersion) {
        ...
        try {
            ...
            if (com.google.android.gms.common.util.zza.zza(packageInfo2.versionCode) >= com.google.android.gms.common.util.zza.zza(minApkVersion)) {
            ...
            Log.w("GooglePlayServicesUtil", "Google Play services out of date for " + packageName + ".  Requires " + minApkVersion + " but found " + packageInfo2.versionCode);
            return 2;
