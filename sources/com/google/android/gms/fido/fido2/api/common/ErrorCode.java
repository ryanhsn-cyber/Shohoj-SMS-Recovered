...
public enum ErrorCode implements Parcelable {
    ...
    public static class UnsupportedErrorCodeException extends Exception {
        public UnsupportedErrorCodeException(int errorCode) {
            super(String.format(Locale.US, "Error code %d is not supported", Integer.valueOf(errorCode)));
        }
    }
    ...
    public static ErrorCode toErrorCode(int code) throws UnsupportedErrorCodeException {
        for (ErrorCode errorCode : values()) {
            if (code == errorCode.zzb) {
                return errorCode;
            }
        }
        throw new UnsupportedErrorCodeException(code);
    }
