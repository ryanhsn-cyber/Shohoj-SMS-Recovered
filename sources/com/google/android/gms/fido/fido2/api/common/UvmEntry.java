...
public class UvmEntry extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel dest, int i) {
        ...
        SafeParcelWriter.writeInt(dest, 1, getUserVerificationMethod());
        SafeParcelWriter.writeShort(dest, 2, getKeyProtectionType());
        SafeParcelWriter.writeShort(dest, 3, getMatcherProtectionType());
