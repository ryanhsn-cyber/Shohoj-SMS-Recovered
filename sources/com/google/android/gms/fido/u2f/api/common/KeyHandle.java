...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    public static KeyHandle parseFromJson(JSONObject registeredKey) throws JSONException {
        ...
        try {
            try {
                return new KeyHandle(Base64.decode(registeredKey.getString(SignResponseData.JSON_RESPONSE_DATA_KEY_HANDLE), 8), ProtocolVersion.fromString(str), registeredKey.has("transports") ? Transport.parseTransports(registeredKey.getJSONArray("transports")) : null);
    ...
    public KeyHandle(byte[] keyHandleBytes, ProtocolVersion protocolVersion, List<Transport> list) {
        this.zza = 1;
