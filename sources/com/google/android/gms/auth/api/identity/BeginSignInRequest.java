...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        public void writeToParcel(Parcel dest, int i) {
            ...
            SafeParcelWriter.writeBoolean(dest, 7, requestVerifiedPhoneNumber());
    ...
    public static final class PasskeyJsonRequestOptions extends AbstractSafeParcelable {
        ...
        public boolean equals(Object o) {
            ...
            PasskeyJsonRequestOptions passkeyJsonRequestOptions = (PasskeyJsonRequestOptions) o;
        ...
        public void writeToParcel(Parcel dest, int i) {
            int beginObjectHeader = SafeParcelWriter.beginObjectHeader(dest);
            SafeParcelWriter.writeBoolean(dest, 1, isSupported());
            SafeParcelWriter.writeString(dest, 2, getRequestJson(), false);
            SafeParcelWriter.finishObjectHeader(dest, beginObjectHeader);
        }
    }
    ...
    public static final class PasskeysRequestOptions extends AbstractSafeParcelable {
        ...
        public boolean equals(Object o) {
            ...
            PasskeysRequestOptions passkeysRequestOptions = (PasskeysRequestOptions) o;
        ...
        public void writeToParcel(Parcel dest, int i) {
            ...
            SafeParcelWriter.writeString(dest, 3, getRpId(), false);
            SafeParcelWriter.finishObjectHeader(dest, beginObjectHeader);
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        SafeParcelWriter.writeInt(dest, 5, this.zbe);
        SafeParcelWriter.writeParcelable(dest, 6, getPasskeysRequestOptions(), flags, false);
        SafeParcelWriter.writeParcelable(dest, 7, getPasskeyJsonRequestOptions(), flags, false);
        SafeParcelWriter.finishObjectHeader(dest, beginObjectHeader);
    }
}
