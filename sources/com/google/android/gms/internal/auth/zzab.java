...
public final class zzab extends GoogleApi implements zzg {
    ...
    private static final Api.AbstractClientBuilder zzb = new zzv();
    private static final Api zzc = new Api("GoogleAuthService.API", zzb, zza);
    private static final Logger zzd = com.google.android.gms.auth.zzd.zza("GoogleAuthServiceClient");
