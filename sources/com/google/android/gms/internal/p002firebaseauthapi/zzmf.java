...
public final class zzmf {
    ...
    private static zzmi zza(zzmi zzmiVar, zzmi zzmiVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod = zzmiVar.zzd.multiply(zzmiVar.zzd).mod(bigInteger2);
        BigInteger mod2 = zzmiVar2.zzd.multiply(zzmiVar2.zzd).mod(bigInteger2);
        BigInteger mod3 = zzmiVar.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmiVar2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzmiVar.zzc.multiply(zzmiVar2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzmiVar2.zzc.multiply(zzmiVar.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            if (!mod5.equals(mod6)) {
                return zzmi.zza;
            }
            return zza(zzmiVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger mod10 = mod6.subtract(mod5).multiply(zzd).mod(bigInteger2);
        BigInteger mod11 = mod3.multiply(mod8).mod(bigInteger2);
        BigInteger mod12 = mod10.multiply(mod10).mod(bigInteger2).subtract(mod9).subtract(mod11.multiply(zzd)).mod(bigInteger2);
        BigInteger mod13 = mod10.multiply(mod11.subtract(mod12)).subtract(mod5.multiply(zzd).multiply(mod9)).mod(bigInteger2);
        BigInteger add = zzmiVar.zzd.add(zzmiVar2.zzd);
        return new zzmi(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }
    ...
    private static zzmi zza(zzmi zzmiVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger mod = zzmiVar.zzb.multiply(zzmiVar.zzb).mod(bigInteger2);
        BigInteger mod2 = zzmiVar.zzc.multiply(zzmiVar.zzc).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmiVar.zzd.multiply(zzmiVar.zzd).mod(bigInteger2);
        BigInteger add = zzmiVar.zzb.add(mod2);
        BigInteger multiply = add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod3).multiply(zzd);
        BigInteger add2 = mod.multiply(zze).add(bigInteger.multiply(mod4).multiply(mod4).mod(bigInteger2));
        BigInteger mod5 = add2.multiply(add2).mod(bigInteger2).subtract(multiply.multiply(zzd)).mod(bigInteger2);
        BigInteger mod6 = add2.multiply(multiply.subtract(mod5)).mod(bigInteger2).subtract(mod3.multiply(zzg)).mod(bigInteger2);
        BigInteger add3 = zzmiVar.zzc.add(zzmiVar.zzd);
        return new zzmi(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }
    ...
    private static zzmi zza(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger mod = new BigInteger(1, zzow.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zzmi(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        zzmi zza3 = zza(ECPoint.POINT_INFINITY, zza2);
        zzmi zza4 = zza(generator, zza2);
