...
interface zzanc {
    ...
    void zza(int i, zzaho zzahoVar) throws IOException;

    <K, V> void zza(int i, zzakg<K, V> zzakgVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzalh zzalhVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzaho> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzalh zzalhVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzalh zzalhVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzalh zzalhVar) throws IOException;
