...
public final class zzmg {
    ...
    public static void zza(long[] jArr, byte[] bArr, byte[] bArr2) throws InvalidKeyException {
        ...
        for (int i3 = 0; i3 < zza.length; i3++) {
            if (MessageDigest.isEqual(zza[i3], copyOf)) {
                throw new InvalidKeyException("Banned public key: " + zzxl.zza(zza[i3]));
            }
        }
        ...
        zzml.zza(jArr22, zza2, jArr);
        zzml.zzd(jArr23, zza2, jArr);
