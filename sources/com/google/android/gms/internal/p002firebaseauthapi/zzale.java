...
public interface zzale {
    ...
    <T> void zza(T t, zzalh<T> zzalhVar, zzaiq zzaiqVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzalh<T> zzalhVar, zzaiq zzaiqVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzakg<K, V> zzakgVar, zzaiq zzaiqVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzalh<T> zzalhVar, zzaiq zzaiqVar) throws IOException;

    void zzb(List<zzaho> list) throws IOException;

    <T> void zzb(List<T> list, zzalh<T> zzalhVar, zzaiq zzaiqVar) throws IOException;
