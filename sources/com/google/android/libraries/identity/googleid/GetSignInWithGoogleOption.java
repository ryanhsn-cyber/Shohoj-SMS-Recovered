...
public final class GetSignInWithGoogleOption extends GetCustomCredentialOption {
    ...
    public GetSignInWithGoogleOption(String serverClientId, String hostedDomainFilter, String nonce) {
        super(GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL, Companion.zza(serverClientId, hostedDomainFilter, nonce, true), Companion.zza(serverClientId, hostedDomainFilter, nonce, true), true, true, null, 32, null);
        Intrinsics.checkNotNullParameter(serverClientId, "serverClientId");
        this.zza = serverClientId;
        this.zzb = hostedDomainFilter;
        this.zzc = nonce;
