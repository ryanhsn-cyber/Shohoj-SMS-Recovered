...
interface zzkq {
    ...
    @Deprecated
    void zzC(List list, zzkr zzkrVar, zzie zzieVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzkr zzkrVar, zzie zzieVar) throws IOException;
    ...
    void zzt(Object obj, zzkr zzkrVar, zzie zzieVar) throws IOException;

    void zzu(Object obj, zzkr zzkrVar, zzie zzieVar) throws IOException;
