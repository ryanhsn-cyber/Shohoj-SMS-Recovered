...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{LogSeverity.WARNING_VALUE, 440}, "DE");
            ...
            add(new int[]{LogSeverity.ERROR_VALUE, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{594}, "RO");
            add(new int[]{599}, "HU");
            add(new int[]{LogSeverity.CRITICAL_VALUE, 601}, "ZA");
            add(new int[]{603}, "GH");
            add(new int[]{608}, "BH");
            add(new int[]{609}, "MU");
            add(new int[]{611}, "MA");
            ...
            add(new int[]{LogSeverity.ALERT_VALUE, 709}, "NO");
            add(new int[]{729}, "IL");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{SQLitePersistence.MAX_ARGS, 919}, "AT");
