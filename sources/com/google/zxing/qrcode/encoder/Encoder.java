...
public final class Encoder {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isOnlyDoubleByteKanji(String content) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean willFit(int numInputBits, Version version, ErrorCorrectionLevel ecLevel) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void appendBytes(String content, Mode mode, BitArray bits, Charset encoding) throws WriterException {
        switch (mode) {
            case NUMERIC:
