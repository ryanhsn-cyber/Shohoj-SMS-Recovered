...
public final class TopKSelector<T> {
    ...
    private void trim() {
        ...
        while (true) {
            ...
            i4++;
            if (i4 >= log2) {
                Arrays.sort(this.buffer, i, i2 + 1, this.comparator);
                break;
            }
        }
        ...
        for (int i5 = i3 + 1; i5 < this.k; i5++) {
            if (this.comparator.compare((Object) NullnessCasts.uncheckedCastNullableTToT(this.buffer[i5]), (Object) NullnessCasts.uncheckedCastNullableTToT(this.threshold)) > 0) {
    ...
    private int partition(int i, int i2, int i3) {
        ...
        for (int i5 = i; i5 < i2; i5++) {
            if (this.comparator.compare((Object) NullnessCasts.uncheckedCastNullableTToT(this.buffer[i5]), uncheckedCastNullableTToT) < 0) {
                swap(i4, i5);
                i4++;
            }
        }
        this.buffer[i2] = this.buffer[i4];
        ((T[]) this.buffer)[i4] = uncheckedCastNullableTToT;
        return i4;
    }
