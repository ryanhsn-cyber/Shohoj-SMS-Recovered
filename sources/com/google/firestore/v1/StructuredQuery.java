...
public final class StructuredQuery extends GeneratedMessageLite<StructuredQuery, Builder> implements StructuredQueryOrBuilder {
    ...
    public static final class Filter extends GeneratedMessageLite<Filter, Builder> implements FilterOrBuilder {
        ...
        public void mergeCompositeFilter(CompositeFilter value) {
            ...
            if (this.filterTypeCase_ == 1 && this.filterType_ != CompositeFilter.getDefaultInstance()) {
                this.filterType_ = CompositeFilter.newBuilder((CompositeFilter) this.filterType_).mergeFrom((CompositeFilter.Builder) value).buildPartial();
            } else {
                this.filterType_ = value;
            }
            this.filterTypeCase_ = 1;
        ...
        public void mergeFieldFilter(FieldFilter value) {
            ...
            if (this.filterTypeCase_ == 2 && this.filterType_ != FieldFilter.getDefaultInstance()) {
                this.filterType_ = FieldFilter.newBuilder((FieldFilter) this.filterType_).mergeFrom((FieldFilter.Builder) value).buildPartial();
            } else {
                this.filterType_ = value;
            }
            this.filterTypeCase_ = 2;
        ...
        public void mergeUnaryFilter(UnaryFilter value) {
            ...
            if (this.filterTypeCase_ == 3 && this.filterType_ != UnaryFilter.getDefaultInstance()) {
                this.filterType_ = UnaryFilter.newBuilder((UnaryFilter) this.filterType_).mergeFrom((UnaryFilter.Builder) value).buildPartial();
            } else {
                this.filterType_ = value;
            }
            this.filterTypeCase_ = 3;
    ...
    public static final class FieldFilter extends GeneratedMessageLite<FieldFilter, Builder> implements FieldFilterOrBuilder {
        ...
        public void mergeField(FieldReference value) {
            ...
            if (this.field_ != null && this.field_ != FieldReference.getDefaultInstance()) {
                this.field_ = FieldReference.newBuilder(this.field_).mergeFrom((FieldReference.Builder) value).buildPartial();
            } else {
                this.field_ = value;
            }
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case NEW_BUILDER:
                    return new Builder();
                case BUILD_MESSAGE_INFO:
                    Object[] objects = {"field_", "op_", "value_"};
                    return newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\t\u0002\f\u0003\t", objects);
                case GET_DEFAULT_INSTANCE:
                    return DEFAULT_INSTANCE;
                case GET_PARSER:
    ...
    public static final class UnaryFilter extends GeneratedMessageLite<UnaryFilter, Builder> implements UnaryFilterOrBuilder {
        ...
        public void mergeField(FieldReference value) {
            ...
            if (this.operandTypeCase_ == 2 && this.operandType_ != FieldReference.getDefaultInstance()) {
                this.operandType_ = FieldReference.newBuilder((FieldReference) this.operandType_).mergeFrom((FieldReference.Builder) value).buildPartial();
            } else {
                this.operandType_ = value;
            }
            this.operandTypeCase_ = 2;
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case NEW_BUILDER:
                    return new Builder();
                case BUILD_MESSAGE_INFO:
                    Object[] objects = {"field_", "direction_"};
                    return newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\t\u0002\f", objects);
                case GET_DEFAULT_INSTANCE:
                    return DEFAULT_INSTANCE;
                case GET_PARSER:
    ...
    public void mergeSelect(Projection value) {
        ...
        if (this.select_ != null && this.select_ != Projection.getDefaultInstance()) {
            this.select_ = Projection.newBuilder(this.select_).mergeFrom((Projection.Builder) value).buildPartial();
        } else {
            this.select_ = value;
        }
    }
    ...
    public void mergeWhere(Filter value) {
        ...
        if (this.where_ != null && this.where_ != Filter.getDefaultInstance()) {
            this.where_ = Filter.newBuilder(this.where_).mergeFrom((Filter.Builder) value).buildPartial();
        } else {
            this.where_ = value;
        }
    }
    ...
    public void mergeStartAt(Cursor value) {
        ...
        if (this.startAt_ != null && this.startAt_ != Cursor.getDefaultInstance()) {
            this.startAt_ = Cursor.newBuilder(this.startAt_).mergeFrom((Cursor.Builder) value).buildPartial();
        } else {
            this.startAt_ = value;
        }
    }
    ...
    public void mergeEndAt(Cursor value) {
        ...
        if (this.endAt_ != null && this.endAt_ != Cursor.getDefaultInstance()) {
            this.endAt_ = Cursor.newBuilder(this.endAt_).mergeFrom((Cursor.Builder) value).buildPartial();
        } else {
            this.endAt_ = value;
        }
    }
    ...
    public void mergeLimit(Int32Value value) {
        ...
        if (this.limit_ != null && this.limit_ != Int32Value.getDefaultInstance()) {
            this.limit_ = Int32Value.newBuilder(this.limit_).mergeFrom((Int32Value.Builder) value).buildPartial();
        } else {
            this.limit_ = value;
        }
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        switch (method) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case BUILD_MESSAGE_INFO:
                Object[] objects = {"select_", "from_", CollectionSelector.class, "where_", "orderBy_", Order.class, "limit_", "offset_", "startAt_", "endAt_"};
